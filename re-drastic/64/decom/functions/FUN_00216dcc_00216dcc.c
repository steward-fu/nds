...
void FUN_00216dcc(long *param_1,uint param_2,int *param_3,int *param_4,undefined4 param_5)
...
LAB_00217154:
          if ((uVar4 < 0xc) || (uVar4 == 0xd)) {
            if (iVar3 == 0x13) {
              afStack_18[0] = afStack_38[0];
            }
            else {
              iVar3 = luaV_tointeger_(afStack_38,afStack_18);
              if (iVar3 == 0) goto LAB_00216e18;
            }
            if ((iStack_20 != 0x13) && (iVar3 = luaV_tointeger_(afStack_28,afStack_18), iVar3 == 0))
            goto LAB_00216e18;
          }
        }
      }
        ...
        afStack_28[0] = (float)param_4[1];
        iStack_20 = 0x13;
        if (6 < uVar4) goto LAB_00217154;
        if ((4 < uVar4) || (uVar4 == 3)) {
          fVar8 = (float)(int)afStack_28[0];
          goto LAB_00217020;
        }
      }
      luaO_arith(*(undefined8 *)(param_1[2] + 0x38),uVar4,afStack_38,afStack_28,afStack_18);
      if (iStack_10 == 0x13) {
        *param_3 = 6;
        param_3[1] = (int)afStack_18[0];
        goto LAB_00216ef4;
      }
      if (afStack_18[0] != 0.0) {
        *param_3 = 5;
