 ...
 *
 * Function : video_3d_resolve_bin_fog_full_4x
 * Address  : 08076fa8
 * Program  : drastic
 */
...
void video_3d_resolve_bin_fog_full_4x(video_3d_render_target_struct *render_target,u32 *dest)

{
  ...
  if ((render_target->fog_active == 0) || ((render_target->video->video_3d).fog_table_constant == 0)
    ...
    video_3d_resolve_bin_4x(dest,render_target);
  }
  else {
    ...
    do {
      video_3d_fog_calculate_weights_4x
                (puVar5,puVar6,pgVar8->fog_table,
                 uVar7 | ((uVar1 & 0x7fff) + (0x400 >> uVar7)) * 0x10000);
      puVar4 = puVar3 + 0x200;
      video_3d_fog_modulate_full_resolve_4x(puVar3,render_target,puVar6,pgVar8->fog_color);
      render_target = (video_3d_render_target_struct *)(render_target->color_buffer_tile + 0x200);
      puVar3 = puVar4;
      puVar5 = puVar5 + 0x200;
    } while (puVar4 != dest + 0x4000);
  }
