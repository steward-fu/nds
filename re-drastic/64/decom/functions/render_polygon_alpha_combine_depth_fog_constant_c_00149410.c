 ...
 *
 * Function : render_polygon_alpha_combine_depth_fog_constant_c
 * Address  : 00149410
 * Program  : drastic64
 */


void render_polygon_alpha_combine_depth_fog_constant_c
    ...
    do {
      while (*(char *)(param_8 + lVar1) != '\0') {
        if (*(char *)(param_7 + lVar1) == '\x1f') {
          *(uint *)(param_1 + lVar1 * 4) = *(uint *)(param_1 + lVar1 * 4) | 0x80000000;
          *(uint *)(param_4 + lVar1 * 4) = param_2 | (uint)param_6 << 0x18;
        }
        else {
          *(byte *)(param_5 + lVar1) = param_6;
          *(uint *)(param_4 + lVar1 * 4) =
               *(uint *)(param_4 + lVar1 * 4) & 0xff000000 | param_2 & 0xffffff;
          *(uint *)(param_1 + lVar1 * 4) =
               *(uint *)(param_1 + lVar1 * 4) | *(uint *)(param_3 + lVar1 * 4) & 0x80000000;
        }
        lVar1 = lVar1 + 1;
