 ...
 *
 * Function : video_3d_resolve_bin_edge_mark_fog_full_gaps_4x
 * Address  : 080773d0
 * Program  : drastic
 */
...
void video_3d_resolve_bin_edge_mark_fog_full_gaps_4x(video_3d_struct *video_3d)

{
  ...
  do {
    ...
    puVar5 = puVar8 + 0x200;
    video_3d_fog_modulate_full_intermediate_4x(puVar8,puVar8,puVar4,pgVar7->fog_color);
    ...
    puVar8 = puVar8 + 0x400;
    video_3d_fog_modulate_full_intermediate_4x(puVar5,puVar5,puVar4,pgVar7->fog_color);
    puVar3 = puVar6 + 0x600;
    puVar6 = puVar6 + 0x800;
