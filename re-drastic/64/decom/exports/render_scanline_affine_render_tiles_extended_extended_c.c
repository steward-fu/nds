 ...
 *
 * Function : render_scanline_affine_render_tiles_extended_extended_c
 * Address  : 001a20c0
 * Program  : drastic64
 */


void render_scanline_affine_render_tiles_extended_extended_c
...

{
  ...
  do {
    if (uVar4 != 0) {
      lVar3 = 0;
      do {
        *(ushort *)(param_1 + lVar3 * 2) =
             (uVar2 >> 0xc) << 8 |
             (ushort)*(byte *)(param_7 + ((ulong)uVar2 & 0x3ff) * 0x40 +
                              (ulong)(*(byte *)(param_2 + lVar3) ^ bVar1));
        lVar3 = lVar3 + 1;
