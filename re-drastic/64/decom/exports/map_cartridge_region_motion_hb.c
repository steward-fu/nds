 ...
 *
 * Function : map_cartridge_region_motion_hb
 * Address  : 0011aa00
 * Program  : drastic64
 */
...

{
  ...
  *(code **)(param_2 + 0x608) = load_motion_hb_low_8;
  *(code **)(param_2 + 0x610) = load_motion_hb_low_16;
  *(code **)(param_2 + 0x618) = load_motion_hb_low_32;
  ...
  *(code **)(param_2 + 0x668) = load_motion_hb_low_8;
  *(code **)(param_2 + 0x670) = load_motion_hb_low_16;
  *(code **)(param_2 + 0x678) = load_motion_hb_low_32;
  ...
  *(code **)(param_2 + 0x6c8) = load_motion_hb_low_8;
  *(code **)(param_2 + 0x6d0) = load_motion_hb_low_16;
  *(code **)(param_2 + 0x6d8) = load_motion_hb_low_32;
  ...
  *(code **)(param_2 + 0x728) = load_motion_hb_low_8;
  *(code **)(param_2 + 0x730) = load_motion_hb_low_16;
  *(code **)(param_2 + 0x738) = load_motion_hb_low_32;
  ...
  *(code **)(param_2 + 0x788) = load_motion_hb_high_8;
  *(code **)(param_2 + 0x790) = load_motion_hb_high_16;
  *(code **)(param_2 + 0x798) = load_motion_hb_high_32;
  ...
  *(code **)(param_2 + 0x7e8) = load_motion_hb_high_8;
  *(code **)(param_2 + 0x7f0) = load_motion_hb_high_16;
  *(code **)(param_2 + 0x7f8) = load_motion_hb_high_32;
