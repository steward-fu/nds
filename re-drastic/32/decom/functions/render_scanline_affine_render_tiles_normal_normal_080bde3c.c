 ...
 *
 * Function : render_scanline_affine_render_tiles_normal_normal
 * Address  : 080bde3c
 * Program  : drastic
 */
...
void render_scanline_affine_render_tiles_normal_normal
    ...
    while( true ) {
      *puVar5 = *puVar2;
      ...
      puVar3 = puVar3 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080bd9bc. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_080bde80 + (uint)bVar4 * 4))(puVar6 + uVar12 * 2,uVar7,param_3,param_4 + 2);
    return;
  default:
    param_2 = param_2 + 4;
    param_3 = param_3 + 2;
    ...
    while( true ) {
      *puVar5 = *puVar2;
      ...
      puVar3 = puVar3 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080bda28. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_080bde80 + (uint)bVar4 * 4))
  ...
  while( true ) {
    *puVar5 = *puVar2;
    ...
    puVar3 = puVar3 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080bd974. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_080bde80 + (uint)bVar4 * 4))
