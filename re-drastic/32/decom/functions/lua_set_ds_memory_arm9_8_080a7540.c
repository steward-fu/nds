...
int lua_set_ds_memory_arm9_8(lua_State *L)

{
  ...
  uVar4 = ((lua_state.system)->cpu_arm9).reg[(address_00 >> 0xb) + 0x15];
  value_00 = (u8)uVar2;
  if ((uVar4 & 0x40000000) == 0) {
    *(u8 *)(address_00 + uVar4 * 4) = value_00;
    ...
    extended_store8(&((lua_state.system)->cpu_arm9).memory_interface,address_00,value_00);
  }
  return 0;
}
