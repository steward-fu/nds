      ...
      if (((uint)piVar7[4] < __len) &&
        ...
        if (param_4 == 0) {
          ...
          while( true ) {
            ...
            uVar6 = *(uint *)((long)piVar8 + 0x2a);
            local_10 = (ulong)uVar6;
            if (__len <= local_10) goto LAB_001a6fa4;
            if (param_4 < uVar9) {
              iVar4 = -1;
...
LAB_001a6fc4:
  ...
  goto LAB_001a6db0;
LAB_001a6fdc:
  if (*(int *)((long)__addr + local_10) != 0x4034b50) {
    iVar4 = -1;
  ...
  uVar6 = (uint)*(ushort *)((long)__addr + local_10 + 0x1a) +
          (uint)*(ushort *)((long)__addr + local_10 + 0x1c) + uVar6 + 0x1e;
