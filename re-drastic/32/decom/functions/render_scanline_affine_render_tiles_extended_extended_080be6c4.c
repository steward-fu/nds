 ...
 *
 * Function : render_scanline_affine_render_tiles_extended_extended
 * Address  : 080be6c4
 * Program  : drastic
 */
...
void render_scanline_affine_render_tiles_extended_extended
    ...
    while( true ) {
      *puVar6 = *puVar2;
      ...
      puVar3 = puVar3 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080bdd38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_080be700 + (uint)bVar4 * 4))
    ...
    while( true ) {
      *puVar6 = *puVar2;
      ...
      puVar3 = puVar3 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080bdda4. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    (**(code **)(&DAT_080be700 + (uint)bVar4 * 4))(puVar7 + uVar12 * 2,uVar8,param_3,param_4 + 2);
    return;
  default:
    param_2 = param_2 + 4;
    param_3 = param_3 + 2;
  ...
  while( true ) {
    *puVar6 = *puVar2;
    ...
    puVar3 = puVar3 + 1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080bde38. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_080be700 + (uint)bVar4 * 4))
