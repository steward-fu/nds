 ...
 *
 * Function : FUN_001dc95c
 * Address  : 001dc95c
 * Program  : drastic64
 */


void FUN_001dc95c(ComprDataIO **param_1)

{
  ...
  pCVar7 = param_1[0x18];
  pCVar9 = param_1[0x1d27];
  uStack_2c = (uint)param_1[0x19];
  uVar4 = (int)pCVar7 - uStack_2c & (uint)param_1[0x1d30];
  if (pCVar9 != (ComprDataIO *)0x0) {
    this = param_1 + 0x1d16;
    pCVar11 = (ComprDataIO *)0x0;
    do {
      lVar13 = (long)pCVar11 * 8;
      puVar12 = *(uint **)(param_1[0x1d26] + (long)pCVar11 * 8);
      if (puVar12 == (uint *)0x0) {
LAB_001dc9ec:
        pCVar11 = pCVar11 + 1;
      }
        ...
        uVar1 = *puVar12;
        uVar10 = (uint)param_1[0x1d30];
        if ((ulong)uVar4 <= ((ulong)(uVar1 - uStack_2c) & (ulong)param_1[0x1d30]))
        goto LAB_001dc9ec;
        uVar2 = puVar12[1];
        pCVar7 = (ComprDataIO *)(ulong)uVar1;
        if (uVar1 != uStack_2c) {
          Unpack::UnpWriteArea((Unpack *)param_1,(ulong)uStack_2c,(ulong)pCVar7);
          uVar10 = (uint)param_1[0x1d30];
          uVar4 = (int)param_1[0x18] - uVar1 & uVar10;
        }
        if (uVar4 < uVar2) {
          pCVar9 = param_1[0x1d27];
          if (pCVar11 < pCVar9) {
            pCVar11 = param_1[0x1d26];
        ...
        uStack_2c = uVar1 + uVar2 & uVar10;
        if (uStack_2c == 0 || uVar1 < uStack_2c) {
          RarVM::SetMemory((RarVM *)this,0,(uchar *)(param_1[0x972] + (long)pCVar7),(ulong)uVar2);
        }
        else {
          uVar5 = (ulong)((int)param_1[0x1d2f] - uVar1);
          RarVM::SetMemory((RarVM *)this,0,(uchar *)(param_1[0x972] + (long)pCVar7),uVar5);
          RarVM::SetMemory((RarVM *)this,uVar5,(uchar *)param_1[0x972],(ulong)uStack_2c);
        }
        lVar15 = *(long *)(param_1[0x1d22] + (ulong)puVar12[4] * 8);
        ...
        *(undefined8 *)(pCVar7 + lVar13) = 0;
        ...
        if (pCVar11 < pCVar9) {
          do {
            ...
            lVar13 = *(long *)(param_1[0x1d22] + (ulong)puVar12[4] * 8);
...
LAB_001dcbf8:
        ...
        uVar5 = (ulong)uVar4;
LAB_001dcc74:
        ComprDataIO::UnpWrite(*param_1,puVar16,uVar5);
        pCVar7 = param_1[0x18];
        *(Unpack *)((long)param_1 + 0x4daa) = (Unpack)0x1;
        uVar4 = (int)pCVar7 - uStack_2c & (uint)param_1[0x1d30];
        param_1[0x9b6] = param_1[0x9b6] + uVar5;
        pCVar9 = param_1[0x1d27];
      }
      else {
        pCVar11 = pCVar11 + 1;
