...
#define __DETOUR_HOOK_H__
    ...
    typedef struct {
        ...
        uintptr_t set_screen_swap;
        uintptr_t set_screen_menu_on;
        uintptr_t set_screen_menu_off;
        uintptr_t set_screen_hires_mode;
        uintptr_t set_screen_orientation;
        uintptr_t set_screen_scale_factor;
    ...
    int init_hook(void);
    int quit_hook(void);
    int set_fast_forward(uint8_t);
    int install_state_handler(const char *);
    int install_render_handler(void);
    int install_prehook_cb(uintptr_t, void *);
