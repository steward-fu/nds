...
void extended_store16(memory_interface_struct *memory_interface,u32 address,u16 value)

{
  ...
  if (uVar1 == '\x01') {
    ...
    *(u16 *)(puVar4 + (address & uVar3)) = value;
                    ...
                    /* WARNING: Could not recover jumptable at 0x08013238. Too many branches */
