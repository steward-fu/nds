 ...
 *
 * Function : extended_load32.part.9
 * Address  : 0800b1bc
 * Program  : drastic
 */
...
u32 extended_load32(memory_interface_struct *memory_interface,u32 address)

{
  ...
  if (uVar1 == '\x01') {
    puVar3 = (u32 *)(*pmVar6[uVar5].load_handler.get_pointer)(memory_interface->memory,address);
    ...
    *(uint *)((int)memory_interface->page_table + ((address & 0xfffff800) >> 9)) = uVar4;
    uVar2 = *(u32 *)(puVar7 + uVar8);
  }
  else {
    if (uVar1 == '\x02') {
                    /* WARNING: Could not recover jumptable at 0x0800b23c. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      uVar2 = (*pmVar6[uVar5].load_handler.extended_function.load32)
