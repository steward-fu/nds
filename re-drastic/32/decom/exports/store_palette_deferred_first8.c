 ...
 *
 * Function : store_palette_deferred_first8
 * Address  : 0800b548
 * Program  : drastic
 */
...
void store_palette_deferred_first8(memory_struct *memory,u32 address,u8 value)

{
  ...
  if ((uint)*(byte *)((int)puVar1 + uVar2) != (uint)value) {
    ...
    video_2d_queue_event
              (video_2d,uVar2 + 0x100000,(uint)value,1,(uint)memory->system->scanline_number);
