 ...
 *
 * Function : video_3d_fog_modulate_full_intermediate_c_1x
 * Address  : 001510f0
 * Program  : drastic64
 */


void video_3d_fog_modulate_full_intermediate_c_1x
...

{
  ...
  if (((param_1 >= param_3 + 0x10 || param_1 + 0x40 <= param_3) && 0x7d < uVar41) &&
      (param_1 < param_3 + 0x10 && param_1 + 0x40 > param_3 || uVar41 != 0x7e)) {
    puVar1 = param_2 + 0x80;
    do {
      auVar29 = *param_3;
      uVar197 = param_2[1];
