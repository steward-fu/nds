...
void lua_rawgetp(long param_1,int param_2,undefined8 param_3)

{
  ...
  local_10 = 2;
  local_18 = param_3;
  plVar2 = (long *)luaH_get(*plVar2,&local_18);
  lVar3 = plVar2[1];
  ...
  *(long *)(param_1 + 0x10) = lVar4 + 0x10;
  if (local_8 - ___stack_chk_guard != 0) {
    ...
    __stack_chk_fail(*(uint *)(lVar4 + 8) & 0xf,&__stack_chk_guard,local_8 - ___stack_chk_guard,0);
  }
  return;
}
