 ...
 *
 * Function : execute_arm_swi_op
 * Address  : 00126fa0
 * Program  : drastic64
 */


void execute_arm_swi_op(long param_1)

{
  ...
  uVar3 = uVar2 & 1;
  if ((uVar2 & 1) == 0) {
    if (uVar1 != 3) goto LAB_00126fc0;
    *(uint *)(param_1 + 0x23a8) = uVar2;
LAB_00127040:
    uVar3 = *(uint *)(param_1 + 0x23c0);
    *(uint *)(param_1 + 0x20f4) = uVar3;
  }
  else {
...
LAB_00126fc0:
      ...
      *(uint *)(param_1 + 0x23a8) = uVar2;
      if (uVar3 == 0) goto LAB_00127040;
    }
    uVar3 = *(uint *)(param_1 + 0x23c0);
    *(uint *)(param_1 + 0x20f4) = uVar3 | 0x20;
  }
  iVar4 = 8;
  if (*(int *)(param_1 + 0x210c) == 1) {
    iVar4 = *(int *)(*(long *)(param_1 + 0x2250) + 0x10) + 8;
  }
  *(int *)(param_1 + 0x23bc) = iVar4;
  *(uint *)(param_1 + 0x23c0) = uVar3 & 0xffffffc0 | 0x93;
  return;
}
