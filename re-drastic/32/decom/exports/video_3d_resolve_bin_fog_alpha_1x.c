 ...
 *
 * Function : video_3d_resolve_bin_fog_alpha_1x
 * Address  : 08073d4c
 * Program  : drastic
 */
...
void video_3d_resolve_bin_fog_alpha_1x(video_3d_render_target_struct *render_target,u32 *dest)

{
  ...
  if ((render_target->fog_active == 0) || ((render_target->video->video_3d).fog_table_constant == 0)
    ...
    do {
      ...
      puVar4 = puVar3 + 0x100;
      video_3d_fog_modulate_alpha_resolve_1x(puVar3,render_target,puVar6,pgVar8->fog_color);
