 ...
 *
 * Function : render_polygon_setup_uv_interpolants
 * Address  : 080c2270
 * Program  : drastic
 */


void render_polygon_setup_uv_interpolants(int param_1,undefined8 *param_2,int param_3,int param_4)

{
  ...
  puVar9 = (undefined4 *)(param_1 + 0x2c0);
  puVar10 = (undefined4 *)(param_1 + 0x370);
