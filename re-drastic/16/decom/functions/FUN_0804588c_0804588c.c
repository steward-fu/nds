 ...
 *
 * Function : FUN_0804588c
 * Address  : 0804588c
 * Program  : drastic16
 */


/* WARNING: Removing unreachable block (ram,0x0804591c) */

void FUN_0804588c(void *param_1,int param_2,int param_3)

{
  ...
  if (param_3 == 0) {
    ...
    FUN_08092c8c(param_1,param_1,auStack_130,*(undefined4 *)(iVar7 + 0x9a64));
  ...
  do {
    ...
    FUN_08092c8c(pvVar4,pvVar4,auStack_130,*(undefined4 *)(iVar7 + 0x9a64));
  ...
  if (param_3 == 0xb) {
    FUN_08092aac(pvVar9,auStack_130,iVar3,uVar1);
    FUN_08092c8c(__src,__src,auStack_130,*(undefined4 *)(iVar7 + 0x9a64));
