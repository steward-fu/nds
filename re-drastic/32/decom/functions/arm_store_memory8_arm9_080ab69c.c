 ...
 *
 * Function : arm_store_memory8_arm9
 * Address  : 080ab69c
 * Program  : drastic
 */


void arm_store_memory8_arm9(uint param_1,u8 param_2,u32 param_3,u32 param_4)

{
        ...
        UNRECOVERED_JUMPTABLE =
             (code *)cpu_block_lookup_base
                               ((cpu_struct *)(unaff_r11[-1].page_allocation_bitmap_fine + 0x7a0),
                                uVar4);
                    /* WARNING: Could not recover jumptable at 0x080ab878. Too many branches */
  ...
  unaff_r11[-1].page_allocation_bitmap_coarse[0x4e] = in_lr;
  unaff_r11[-1].page_allocation_bitmap_coarse[0x4c] = (u32)register0x00000054;
  store_io_register_arm9_8(memory,param_1 & 0xffffff,param_2);
