 ...
 *
 * Function : render_polygon_alpha_combine_depth_fog_c
 * Address  : 00149210
 * Program  : drastic64
 */


void render_polygon_alpha_combine_depth_fog_c
    ...
    do {
      while (*(char *)(param_8 + lVar1) != '\0') {
        if (*(char *)(param_7 + lVar1) == '\x1f') {
          ...
          *(uint *)(param_2 + lVar1 * 4) =
               *(uint *)(param_4 + lVar1 * 4) & 0xff000000 |
               *(uint *)(param_2 + lVar1 * 4) & 0xffffff;
