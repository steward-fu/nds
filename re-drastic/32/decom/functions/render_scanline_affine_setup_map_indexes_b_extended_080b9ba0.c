 ...
 *
 * Function : render_scanline_affine_setup_map_indexes_b_extended
 * Address  : 080b9ba0
 * Program  : drastic
 */
...
void render_scanline_affine_setup_map_indexes_b_extended
...

{
  ...
  uVar1 = (((ushort)wrap_mask & (ushort)(source_x >> 0xb)) +
          (short)((wrap_mask & source_y >> 0xb) << (map_pitch_shift & 0xff))) * 2;
  uVar8 = uVar3;
  if (uVar3 == 0) {
    iVar7 = 0x100;
    uVar2 = 0x20;
