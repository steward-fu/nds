 ...
 *
 * Function : video_3d_edge_identify_bottom_c_1x
 * Address  : 00150960
 * Program  : drastic64
 */


void video_3d_edge_identify_bottom_c_1x
...

{
  ...
  do {
    while( true ) {
      ...
      lVar6 = lVar6 + 1;
      if (lVar6 == 0xfe) goto LAB_00150a90;
    }
...
LAB_00150a90:
  ...
  if ((uVar2 >> 0x1e & 1) != 0) {
    ...
    bVar7 = -((param_3[0xfe] >> 0x18 & 0x3f) == uVar1 || (param_3[0xfe] & 0xffffff) <= uVar2);
    if (uVar2 < (uVar8 & 0xffffff) && uVar4 != uVar1) {
      bVar7 = 0;
    }
    else if ((param_2[0xff] >> 0x18 & 0x3f) != uVar1 && uVar2 < (param_2[0xff] & 0xffffff)) {
      bVar7 = 0;
    }
