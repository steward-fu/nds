 ...
 *
 * Function : FUN_08050654
 * Address  : 08050654
 * Program  : drastic16
 */


uint FUN_08050654(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  *(undefined *)(param_1 + 0x9a8f) = 0;
  return (uint)*(byte *)(param_1 + 0x9a8b) << 0xd | (uint)*(byte *)(param_1 + 0x9a8a) << 8 |
         0x6000000 | (uint)*(byte *)(param_1 + 0x9a8d) << 0x1b |
         (uint)*(byte *)(param_1 + 0x9a80) << 1;
}
