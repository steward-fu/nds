 ...
 *
 * Function : arm64_store_block2
 * Address  : 0018e430
 * Program  : drastic64
 */


void arm64_store_block2(ulong param_1)

{
  ...
  *(uint *)(unaff_x28 + 0x2334) = uVar2;
  iVar4 = cpu_block_check_allocation_block2();
  if (iVar4 == 0) {
  ...
  *(undefined4 *)(unaff_x28 + 0x23bc) = uVar5;
  ...
  nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018e520. Too many branches */
