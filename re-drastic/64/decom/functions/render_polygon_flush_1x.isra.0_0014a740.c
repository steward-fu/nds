 ...
 *
 * Function : render_polygon_flush_1x.isra.0
 * Address  : 0014a740
 * Program  : drastic64
 */
...
void render_polygon_flush_1x_isra_0
...

{
  ...
  lVar10 = ((ulong)param_4 & 0xffffff) * 0x400;
...
LAB_0014a870:
    if ((param_8 & 1) != 0) goto LAB_0014a87c;
LAB_0014aaf0:
    render_polygon_load_depth_asm_1x(uVar32,lVar25,param_2,uVar28);
    if ((*(uint *)(param_3 + 4) >> 0xe & 1) == 0) goto LAB_0014ab10;
LAB_0014a8b4:
    if ((param_8 & 0x10) == 0) {
...
LAB_0014a8dc:
    ...
    render_polygon_set_buffer32_asm(lVar3,uVar31,param_7);
    if ((param_8 & 1) == 0) goto LAB_0014aaf0;
LAB_0014a87c:
    render_polygon_load_depth_colors_id_asm_1x
              (uVar32,lVar18,lVar2,lVar25,lVar10,param_1 + 0x20000 + (ulong)(param_4 << 8),param_2,
               uVar28);
    if ((*(uint *)(param_3 + 4) >> 0xe & 1) != 0) goto LAB_0014a8b4;
LAB_0014ab10:
    if ((param_8 & 0x10) == 0) {
  ...
  if ((uVar6 >> 4 & 3) == 3) {
    ...
    if (uVar21 == 0) {
      if ((uVar9 & (uVar29 ^ 0xffffffff)) == 0) {
        if (param_7 != 0) goto LAB_0014af14;
LAB_0014af38:
        if (uVar27 == 0) goto LAB_0014aa90;
      }
      else {
        *(uint *)(param_1 + 0x24010) = uVar9 | uVar29;
        uVar29 = uVar29 >> (ulong)(param_4 & 0x1f);
        if (uVar27 == 0) {
          if (param_7 == 0) goto LAB_0014aa90;
LAB_0014af14:
          lVar22 = 0;
          do {
        ...
        puVar20 = (ulong *)(lVar25 + 0x400);
        do {
          puVar15 = puVar20 + -0x80;
          if ((uVar29 & 1) == 0) {
            do {
              puVar16 = puVar15 + 2;
          ...
          uVar29 = uVar29 >> 1;
        } while (puVar20 != (ulong *)(lVar25 + (ulong)(uVar27 - 1) * 0x400 + 0x800));
        if (param_7 != 0) goto LAB_0014af14;
      }
      lVar22 = 0;
      uVar24 = 0;
    ...
    *(uint *)(param_1 + 0x24010) = uVar29 & (uVar9 ^ 0xffffffff);
    ...
    do {
      while( true ) {
        ...
        if (param_7 <= (uint)lVar19) goto LAB_0014a8f4;
      }
...
LAB_0014a8f4:
  local_30 = param_8 & 1;
  local_80 = &local_c;
  if (local_c == 0) goto LAB_0014aa90;
  ...
  if ((param_8 >> 2 & 1) == 0) {
    ...
    if ((param_8 >> 1 & 1) != 0) goto LAB_0014ac78;
LAB_0014a978:
    ...
    uVar12 = (ulong)uVar5 & 0x1f0000;
    uVar23 = (undefined4)(uVar12 >> 0x10);
    if ((param_8 >> 1 & 1) == 0) goto LAB_0014a978;
LAB_0014ac78:
  ...
  if (local_30 == 0) {
    ...
    if (param_7 == local_c) {
      render_polygon_writeback_all_pass_asm_1x
                (param_2,lVar10,lVar25,param_5 & 0xffffffff,uVar21,lVar19,lVar3);
    }
    else {
      render_polygon_writeback_asm_1x
    ...
    render_polygon_writeback_alpha_asm_1x
              (param_2,lVar10,lVar25,param_1 + 0x20000 + (ulong)(param_4 << 8),uVar28,lVar26,lVar3,
               lVar2);
  }
LAB_0014aa90:
