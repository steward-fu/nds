...
ulong extended_load16(long param_1,ulong param_2)

{
  ...
  if (*(byte *)(lVar1 + 0x58) == 1) {
    uVar3 = uVar8 & 0x7ff;
    puVar7 = (ushort *)(**(code **)(lVar1 + 8))(*(undefined8 *)(nds_system + param_1 + 0xb04008));
    uVar6 = uVar8 - uVar3;
  ...
  if (uVar15 == 2) {
                    /* WARNING: Could not recover jumptable at 0x00118514. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    uVar14 = (**(code **)(lVar1 + 0x10))
  ...
  *(ulong *)(param_1 + (uVar14 >> 0xb) * 8) = uVar4;
  return (ulong)*(ushort *)(lVar13 + uVar12);
}
