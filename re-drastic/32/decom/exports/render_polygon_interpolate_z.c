 ...
 *
 * Function : render_polygon_interpolate_z
 * Address  : 080c1e68
 * Program  : drastic
 */


void render_polygon_interpolate_z(undefined8 *param_1,int param_2,int param_3)

{
  ...
  puVar8 = (undefined4 *)(param_2 + 0x210);
  puVar4 = (undefined4 *)(param_2 + 0x160);
  puVar7 = (ushort *)(param_2 + 0x630);
  do {
    ...
    auVar10 = VectorMultiplyAccumulate
                        (uVar13,CONCAT44(reciprocal_table[*puVar7],reciprocal_table[*puVar7]),4,0);
