 ...
 *
 * Function : arm_load_ext8_signed
 * Address  : 080ab4b4
 * Program  : drastic
 */


undefined8 arm_load_ext8_signed(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  if ((param_1 & 0xfb000000) == 0) {
    ...
    uVar2 = load_io_register_arm9_8(memory,param_1 & 0x7fffff);
    return CONCAT44(unaff_r11[-1].page_allocation_bitmap_coarse[0x4f],(int)(char)uVar2);
  }
  ...
  if (iVar1 == 0) {
    ...
    unaff_r11[-1].page_allocation_bitmap_coarse[0x4e] = in_lr;
    unaff_r11[-1].page_allocation_bitmap_coarse[0x4c] = (u32)register0x00000054;
    uVar2 = extended_load8(unaff_r11,param_1);
    return CONCAT44(unaff_r11[-1].page_allocation_bitmap_coarse[0x4f],(int)(char)uVar2);
  }
  return CONCAT44(iVar1,(int)*(char *)(param_1 + iVar1));
}
