 ...
 *
 * Function : arm_store_memory8_arm7
 * Address  : 080abcdc
 * Program  : drastic
 */


void arm_store_memory8_arm7(uint param_1,u8 param_2,u32 param_3,u32 param_4)

{
  ...
  if (!(bool)((byte)(unaff_r11->page_table[param_1 >> 0xb] >> 0x1e) & 1)) {
    *(u8 *)(param_1 + unaff_r11->page_table[param_1 >> 0xb] * 4) = param_2;
    return;
  }
  ...
  if (((param_1 & 0xfb000000) != 0) || ((param_1 & 0x4000000) == 0)) {
    ...
    if ((unaff_r11->page_table[param_1 >> 0xb] >> 0x1e & 2) == 0) {
      ...
      extended_store8(unaff_r11,param_1,param_2);
    }
    else if (param_2 != *(u8 *)(param_1 + iVar1)) {
      *(u8 *)(param_1 + iVar1) = param_2;
      unaff_r11[-1].page_allocation_bitmap_coarse[0x41] = param_1;
      unaff_r11[-1].page_allocation_bitmap_coarse[0x32] = in_r12;
      if (in_OV) {
        uVar4 = 0x10000000;
      }
      ...
      unaff_r11[-1].page_allocation_bitmap_coarse[0x4e] = in_lr;
      unaff_r11[-1].page_allocation_bitmap_coarse[0x4c] = (u32)register0x00000054;
      uVar4 = cpu_block_check_allocation8
                        ((cpu_struct *)(unaff_r11[-1].page_allocation_bitmap_fine + 0x7a0),param_1);
        ...
        UNRECOVERED_JUMPTABLE =
             (code *)cpu_block_lookup_base
                               ((cpu_struct *)(unaff_r11[-1].page_allocation_bitmap_fine + 0x7a0),
                                uVar4);
                    /* WARNING: Could not recover jumptable at 0x080abeb8. Too many branches */
  ...
  unaff_r11[-1].page_allocation_bitmap_coarse[0x4e] = in_lr;
  unaff_r11[-1].page_allocation_bitmap_coarse[0x4c] = (u32)register0x00000054;
  store_io_register_arm7_8(memory,param_1 & 0xffffff,param_2);
