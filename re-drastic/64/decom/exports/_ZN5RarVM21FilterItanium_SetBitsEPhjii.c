...
/* RarVM::FilterItanium_SetBits(unsigned char*, unsigned int, int, int) */

void __thiscall
RarVM::FilterItanium_SetBits(RarVM *this,uchar *param_1,uint param_2,int param_3,int param_4)
