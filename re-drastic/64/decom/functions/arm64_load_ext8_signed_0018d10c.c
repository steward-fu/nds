 ...
 *
 * Function : arm64_load_ext8_signed
 * Address  : 0018d10c
 * Program  : drastic64
 */


ulong arm64_load_ext8_signed(ulong param_1)

{
  ...
  if (((uint)(param_1 >> 0x18) & 0xff) == 4) {
    ...
    *(undefined4 *)(unaff_x28 + 0x2290) = in_w12;
    cVar3 = load_io_register_arm9_8(*(undefined8 *)(unaff_x28 + 0x2260),(uint)param_1 & 0x7fffff);
    nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
    return (ulong)(uint)(int)cVar3;
  }
  lVar1 = *(long *)(in_x9 + (param_1 >> 0xb & 0x1fffff) * 8) * 4;
  if (lVar1 != 0) {
    return (long)*(char *)(lVar1 + (param_1 & 0xffffffff));
  }
  *(undefined4 *)(in_x9 + -0xe0) = in_w12;
  *(undefined4 *)(in_x9 + -0xdc) = in_w13;
  *(undefined4 *)(in_x9 + -0xd8) = in_w14;
