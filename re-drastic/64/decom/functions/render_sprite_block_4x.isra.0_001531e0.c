 ...
 *
 * Function : render_sprite_block_4x.isra.0
 * Address  : 001531e0
 * Program  : drastic64
 */
...
void render_sprite_block_4x_isra_0
...

{
  ...
  uVar17 = (ulong)uVar7;
  lVar15 = (ulong)(uint)(param_6 << 9) + (param_5 & 0xffffffff);
  ...
  if ((param_13 & 1) == 0) {
    render_sprite_load_depth_asm_4x(param_4,lVar18,param_9,param_10);
  }
  else {
    render_sprite_load_depth_colors_id_asm_4x
  ...
  if (local_c == 0) goto LAB_00153670;
  ...
  if ((param_13 & 1) == 0) {
    ...
    render_sprite_writeback_c_4x(lVar19,lVar18,param_9,param_10,puVar20,param_11,lVar2);
    goto LAB_00153670;
  }
  ...
  if ((*(char *)(param_3 + 0x49) == '\x01') || (*(char *)(param_3 + 0x49) == '\x06')) {
    if (uVar7 != 0) {
      if (uVar7 - 1 < 3) {
        ...
        if ((uVar7 & 3) == 0) goto LAB_00153548;
      }
...
LAB_00153548:
  ...
  if ((param_10 != 0) && (param_9 != 0)) {
    ...
    lVar3 = lVar19 + ((ulong)(param_10 - 1) + 1) * 0x800;
    do {
      lVar12 = 0;
      do {
