...
void reset_texture_cache(texture_cache_struct *texture_cache)

{
  ...
  texture_cache->texture_slots_allocated = 0;
  texture_cache->texture_slots_allocated_last = 0;
  texture_cache->texture_palette_slots_allocated = 0;
  texture_cache->texture_palette_slots_allocated_last = 0;
  return;
}
