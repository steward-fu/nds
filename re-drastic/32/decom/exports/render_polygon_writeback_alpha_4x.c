 ...
 *
 * Function : render_polygon_writeback_alpha_4x
 * Address  : 080c4c6c
 * Program  : drastic
 */


/* WARNING: Heritage AFTER dead removal. Example location: s1 : 0x080c4cf8 */
/* WARNING: Restarted to delay deadcode elimination for space: register */

void render_polygon_writeback_alpha_4x
    ...
    do {
      ...
      *puVar4 = uVar17;
      ...
      iVar8 = iVar7;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080c4cf8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (**(code **)(&DAT_080c4d00 + (iVar7 + 8) * 4))
