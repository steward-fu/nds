 ...
 *
 * Function : execute_arm_bkpt_op
 * Address  : 00126ed0
 * Program  : drastic64
 */


void execute_arm_bkpt_op(long param_1)

{
  ...
  uVar3 = uVar2 & 1;
  if ((uVar2 & 1) == 0) {
    if (uVar1 != 4) goto LAB_00126ef0;
    *(uint *)(param_1 + 0x23a8) = uVar2;
LAB_00126f70:
    uVar3 = *(uint *)(param_1 + 0x23c0);
    *(uint *)(param_1 + 0x20f8) = uVar3;
  }
  else {
...
LAB_00126ef0:
      ...
      *(uint *)(param_1 + 0x23a8) = uVar2;
      if (uVar3 == 0) goto LAB_00126f70;
    }
    uVar3 = *(uint *)(param_1 + 0x23c0);
    *(uint *)(param_1 + 0x20f8) = uVar3 | 0x20;
  }
  iVar4 = 0xc;
  if (*(int *)(param_1 + 0x210c) == 1) {
    iVar4 = *(int *)(*(long *)(param_1 + 0x2250) + 0x10) + 0xc;
  }
  *(int *)(param_1 + 0x23bc) = iVar4;
  *(uint *)(param_1 + 0x23c0) = uVar3 & 0xffffffc0 | 0x97;
  return;
}
