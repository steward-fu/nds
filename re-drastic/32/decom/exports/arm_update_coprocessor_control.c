 ...
 *
 * Function : arm_update_coprocessor_control
 * Address  : 080aee50
 * Program  : drastic
 */


void arm_update_coprocessor_control
...

{
  ...
  *(BADSPACEBASE **)(unaff_r11 + -0xd0) = register0x00000054;
  uVar1 = update_coprocessor_control(*(coprocessor_struct **)(unaff_r11 + -0x7c));
    ...
    *(undefined4 *)(unaff_r11 + -0xd0) = *(undefined4 *)(unaff_r11 + -0xd0);
    UNRECOVERED_JUMPTABLE =
         (code *)cpu_block_lookup_base
                    ...
                    /* WARNING: Could not recover jumptable at 0x080aef30. Too many branches */
