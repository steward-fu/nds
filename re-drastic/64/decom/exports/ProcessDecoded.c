...
/* Unpack::ProcessDecoded(UnpackThreadData&) */

void __thiscall Unpack::ProcessDecoded(Unpack *this,UnpackThreadData *param_1)

{
  ...
  piVar27 = *(int **)(param_1 + 0x4ae0);
  local_8 = ___stack_chk_guard;
  piVar28 = piVar27 + (ulong)*(uint *)(param_1 + 0x4ae8) * 3;
  if (piVar27 < piVar28) {
    do {
      while( true ) {
        uVar14 = *(ulong *)(this + 0xe980) & *(ulong *)(this + 0xc0);
        *(ulong *)(this + 0xc0) = uVar14;
        if (((*(ulong *)(this + 0x4b88) - uVar14 & *(ulong *)(this + 0xe980)) < 0x1004 &&
             uVar14 != *(ulong *)(this + 0x4b88)) &&
           (UnpWriteBuf(), *(long *)(this + 0x4da0) < *(long *)(this + 0x4db0))) {
          uVar15 = 0;
          goto LAB_001ddb2c;
        }
        iVar8 = *piVar27;
        ...
        if (iVar8 == 1) {
          ...
          *(int *)(this + 0xa0) = piVar27[2];
          *(undefined4 *)(this + 0xa4) = uVar6;
          *(undefined4 *)(this + 0xa8) = uVar7;
          *(undefined4 *)(this + 0xac) = uVar9;
          *(uint *)(this + 0xb4) = (uint)uVar10;
          uVar19 = *(ulong *)(this + 0xc0);
          uVar25 = uVar19 - (uint)piVar27[2];
          uVar14 = uVar19;
          if (uVar19 < uVar25) {
            uVar14 = uVar25;
          }
          if (uVar14 < *(long *)(this + 0xe978) - 0x1001U) {
            *(ulong *)(this + 0xc0) = uVar19 + uVar10;
            puVar26 = (undefined *)(*(long *)(this + 0x4b90) + uVar25);
            puVar23 = (undefined *)(*(long *)(this + 0x4b90) + uVar19);
            if (7 < uVar10) {
              lVar16 = uVar25 + 0x10;
              uVar18 = uVar10 - 8;
              uVar14 = uVar19 + 0x10;
            ...
            while( true ) {
              uVar21 = uVar14;
              *(undefined *)(*(long *)(this + 0x4b90) + uVar19) =
                   *(undefined *)(*(long *)(this + 0x4b90) + (uVar20 & uVar24));
              uVar24 = *(ulong *)(this + 0xe980);
              uVar19 = *(long *)(this + 0xc0) + 1U & uVar24;
              *(ulong *)(this + 0xc0) = uVar19;
          ...
          uVar18 = piVar27[2];
          uVar11 = *(uint *)(this + ((ulong)uVar18 + 0x28) * 4);
          if (uVar18 != 0) {
            lVar16 = (ulong)(uVar18 - 1) * -4;
            __n = ((ulong)(uVar18 - 1) + 1) * 4;
            memmove(this + lVar16 + ((ulong)uVar18 + 0x28) * 4,this + __n + 0x9c + lVar16,__n);
          }
          uVar25 = *(ulong *)(this + 0xc0);
          uVar10 = *(ushort *)(piVar27 + 1);
          uVar14 = uVar25 - uVar11;
          *(uint *)(this + 0xa0) = uVar11;
          uVar18 = (uint)uVar10;
          *(uint *)(this + 0xb4) = uVar18;
          uVar19 = uVar25;
          if (uVar25 < uVar14) {
            uVar19 = uVar14;
          }
          if (uVar19 < *(long *)(this + 0xe978) - 0x1001U) {
            *(ulong *)(this + 0xc0) = uVar25 + uVar10;
            puVar26 = (undefined *)(*(long *)(this + 0x4b90) + uVar14);
            puVar23 = (undefined *)(*(long *)(this + 0x4b90) + uVar25);
            if (7 < uVar10) {
              uVar18 = uVar10 - 8;
            ...
            uVar20 = *(ulong *)(this + 0xe980);
            uVar19 = uVar14 + (uVar10 - 1);
            do {
              uVar20 = uVar14 & uVar20;
              bVar13 = uVar14 != uVar19;
              uVar14 = uVar14 + 1;
              *(undefined *)(*(long *)(this + 0x4b90) + uVar25) =
                   *(undefined *)(*(long *)(this + 0x4b90) + uVar20);
              uVar20 = *(ulong *)(this + 0xe980);
              uVar25 = *(long *)(this + 0xc0) + 1U & uVar20;
              *(ulong *)(this + 0xc0) = uVar25;
            } while (bVar13);
          }
        }
        else if (iVar8 == 2) {
          uVar18 = *(uint *)(this + 0xb4);
          if (uVar18 != 0) {
            uVar19 = *(ulong *)(this + 0xc0);
            uVar25 = uVar19 - *(uint *)(this + 0xa0);
            uVar14 = uVar19;
            if (uVar19 < uVar25) {
              uVar14 = uVar25;
            }
            lVar16 = *(long *)(this + 0x4b90);
            if (uVar14 < *(long *)(this + 0xe978) - 0x1001U) {
              *(ulong *)(this + 0xc0) = uVar19 + uVar18;
              ...
              *(undefined *)(lVar16 + uVar19) =
                   *(undefined *)(lVar16 + (uVar25 & *(ulong *)(this + 0xe980)));
              uVar20 = *(ulong *)(this + 0xe980);
              uVar19 = *(long *)(this + 0xc0) + 1U & uVar20;
              *(ulong *)(this + 0xc0) = uVar19;
              if (uVar18 != 1) {
                do {
          ...
          local_10 = piVar27[8];
          piVar27 = piVar27 + 6;
          local_20[0] = SUB21(*(undefined2 *)piVar1,0);
          local_14 = (undefined)*(undefined2 *)piVar2;
          local_c = (undefined)*(undefined2 *)piVar3;
          AddFilter(this,local_20);
        }
LAB_001dd9c8:
        piVar27 = piVar27 + 3;
      ...
      *(ulong *)(this + 0xc0) = uVar14 + 1;
      *(undefined *)(*(long *)(this + 0x4b90) + (uVar14 & *(ulong *)(this + 0xe980))) =
           *(undefined *)(piVar27 + 2);
      ...
      *(undefined *)(*(long *)(this + 0x4b90) + (uVar14 & *(ulong *)(this + 0xe980))) =
      ...
      do {
        uVar19 = *(ulong *)(this + 0xc0);
        *(ulong *)(this + 0xc0) = uVar19 + 1;
        uVar18 = (int)uVar14 + 1;
        *(undefined *)(*(long *)(this + 0x4b90) + (uVar19 & *(ulong *)(this + 0xe980))) =
...
LAB_001ddb2c:
  ...
  __stack_chk_fail(uVar15,local_8 - ___stack_chk_guard,0);
}
