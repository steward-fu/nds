...

{
        ...
        if (uVar3 - 2 < 7) {
          ...
          if (uVar10 != uVar13) {
            ...
            if (((uVar12 & 0x1c000000) != 0) && ((param_3[1] >> 4 & 3) != 3)) {
              ...
              if (uVar12 != local_48 || uVar5 != local_44) {
                local_40 = texture_cache_lookup(*(undefined8 *)(param_1 + 0x9a38));
                uVar20 = param_3[2];
                local_48 = uVar12;
                local_44 = (uint)uVar5;
              }
            ...
            uVar3 = 0xfffU >> (ulong)(0xbU - (iVar4 >> 4) & 0x1f) &
                    0xfff << (ulong)((int)uVar13 >> 4 & 0x1f);
  ...
  video_3d_bin_polygons_y_sort_1x(param_1,param_2,param_3,param_4,param_5);
  return;
}
