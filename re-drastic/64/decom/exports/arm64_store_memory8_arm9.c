 ...
 *
 * Function : arm64_store_memory8_arm9
 * Address  : 0018d30c
 * Program  : drastic64
 */


ulong arm64_store_memory8_arm9(ulong param_1,char param_2)

{
      ...
      if ((int)uVar7 != 0) {
        ...
        *(undefined4 *)(unaff_x28 + 0x23bc) = uVar6;
        ...
        nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018d488. Too many branches */
  ...
  *(undefined4 *)(unaff_x28 + 0x2290) = in_w12;
  store_io_register_arm9_8(*(undefined8 *)(unaff_x28 + 0x2260),(uint)param_1 & 0xffffff,param_2);
