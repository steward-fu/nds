 ...
 *
 * Function : render_polygon_generate_texture_addresses_clamp_flip
 * Address  : 080c271c
 * Program  : drastic
 */


void render_polygon_generate_texture_addresses_clamp_flip
  ...
  do {
    ...
    *param_1 = auVar8._0_8_;
    ...
    param_3 = iVar4 + -8;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080c2794. Too many branches */
