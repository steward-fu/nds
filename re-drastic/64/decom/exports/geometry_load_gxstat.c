...
uint geometry_load_gxstat(long param_1)

{
  ...
  *(undefined *)(param_1 + 0x9aca) = 0;
  return (uint)*(byte *)(param_1 + 0x9ac5) << 8 | (uint)*(byte *)(param_1 + 0x9abe) << 1 |
         (uint)*(byte *)(param_1 + 0x9ac8) << 0x1b | (uint)*(byte *)(param_1 + 0x9ac6) << 0xd |
         0x6000000;
}
