...
void update_frame_3d_4x(video_struct *video,u32 skip_frame)
...
LAB_08078500:
        ...
        uVar14 = 1;
        video_3d_bin_polygons_y_sort_4x
                  (geometry,(video->video_3d).polygon_bins,geometry->polygon_list + uVar12,
                   geometry->vertex_list[uVar12].vertexes);
        video_3d_bin_polygons_4x
        ...
        if (uVar12 < 2) {
          ...
          video_3d_render_bins_4x((video->video_3d).render_targets);
        }
        else {
        ...
        if (uVar12 != 2) {
          if (uVar12 != 3) {
            video_3d_resolve_bin_edge_mark_gaps_4x(video_3d_00);
            return;
          }
          video_3d_resolve_bin_edge_mark_fog_alpha_gaps_4x(video_3d_00);
          return;
        }
        video_3d_resolve_bin_edge_mark_fog_full_gaps_4x(video_3d_00);
        return;
      }
    }
  }
