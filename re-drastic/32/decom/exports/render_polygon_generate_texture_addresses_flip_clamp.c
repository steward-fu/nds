 ...
 *
 * Function : render_polygon_generate_texture_addresses_flip_clamp
 * Address  : 080c255c
 * Program  : drastic
 */


void render_polygon_generate_texture_addresses_flip_clamp
...

{
  ...
  auVar10._4_4_ = CONCAT22(param_4,param_4);
  auVar10._0_4_ = CONCAT22(param_4,param_4);
  auVar10._8_8_ = 0;
  ...
  auVar15 = auVar10 & auVar10 << 0x40 & ~auVar13;
  auVar10 = ZEXT816(0);
  ...
  do {
    ...
    uVar11 = *param_6;
    param_6 = param_6 + 1;
    auVar16 = VectorTest(in_q0,auVar15);
    auVar8 = VectorMax(auVar10,in_q1,2,0);
    auVar12 = VectorCopyLong(uVar11,1,0);
    auVar8 = VectorMin(auVar8,auVar14,2,0);
    in_q0 = (in_q0 ^ auVar16) & auVar13 & auVar12;
    in_q1 = auVar8 & auVar12;
    ...
    *param_1 = auVar8._0_8_;
    ...
    param_3 = iVar4 + -8;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080c25d4. Too many branches */
