 ...
 *
 * Function : arm_load_block1
 * Address  : 080ac63c
 * Program  : drastic
 */


u32 * arm_load_block1(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  unaff_r11[-1].page_allocation_bitmap_coarse[0x50] = *(u32 *)((param_1 & 0xfffffffc) + iVar2);
  return unaff_r11[-1].page_allocation_bitmap_coarse + 0x50;
}
