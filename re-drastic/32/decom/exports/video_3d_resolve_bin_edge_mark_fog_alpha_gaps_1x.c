...
void video_3d_resolve_bin_edge_mark_fog_alpha_gaps_1x(video_3d_struct *video_3d)

{
  ...
  do {
    ...
    puVar5 = puVar7 + 0x100;
    video_3d_fog_modulate_alpha_resolve_1x(puVar7,puVar7,puVar4,pgVar11->fog_color);
    ...
    puVar7 = puVar7 + 0x200;
    video_3d_fog_modulate_alpha_resolve_1x(puVar5,puVar5,puVar4,pgVar11->fog_color);
    puVar3 = puVar6 + 0x300;
    puVar6 = puVar6 + 0x400;
