...
void __thiscall SecPassword::Set(SecPassword *this,wchar_t *param_1)

{
  ...
  if (*param_1 == L'\0') {
    this[0x200] = (SecPassword)0x0;
    memset(this,0,0x200);
    return;
  }
  this[0x200] = (SecPassword)0x1;
  sVar2 = wcslen(param_1);
  __n = (sVar2 + 1) * 4;
  if (0x7f < sVar2 + 1) {
    __n = 0x200;
  }
  memcpy(this,param_1,__n);
  _Var1 = getpid();
  cVar5 = (char)_Var1 + 'K';
  ...
  do {
    ...
    *puVar3 = CONCAT17(cVar7 + '\x06' + cVar5 ^ (byte)((ulong)uVar8 >> 0x38),
    ...
    cVar7 = cVar7 + '\x10';
    cVar6 = cVar6 + '\x10';
  } while ((undefined8 *)(this + 0x200) != puVar4);
  return;
}
