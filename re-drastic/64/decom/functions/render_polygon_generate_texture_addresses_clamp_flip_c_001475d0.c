 ...
 *
 * Function : render_polygon_generate_texture_addresses_clamp_flip_c
 * Address  : 001475d0
 * Program  : drastic64
 */
...
void render_polygon_generate_texture_addresses_clamp_flip_c
               (undefined8 *param_1,short *param_2,ulong param_3,uint param_4,uint param_5)
