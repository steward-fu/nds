 ...
 *
 * Function : FUN_00158f0c
 * Address  : 00158f0c
 * Program  : drastic64
 */


void FUN_00158f0c(long param_1,int param_2)
...
LAB_00158fcc:
        ...
        *(void **)(polygon_sort_list_15121 + param_1 + 0xe5528) = __dest;
        ...
        video_3d_bin_polygons_y_sort_4x(lVar11,param_1 + 0x2856c0,lVar11 + lVar12 + 0x39ae0,lVar2,0)
        ;
        video_3d_bin_polygons_4x(lVar11,param_1 + 0x2916f0,lVar11 + lVar12 + 0x59af0,lVar2,1);
        lVar11 = *(long *)(param_1 + 8);
        ...
        if (uVar5 < 2) {
          ...
          video_3d_render_bins_4x(param_1 + 0x29d740);
        }
        else {
        ...
        if (uVar5 == 2) {
          video_3d_resolve_bin_edge_mark_fog_full_gaps_4x(pvVar1);
          return;
        }
        if (uVar5 != 3) {
          video_3d_resolve_bin_edge_mark_gaps_4x();
          return;
        }
        video_3d_resolve_bin_edge_mark_fog_alpha_gaps_4x(pvVar1);
        return;
      }
    }
  }
  ...
  memcpy(__dest,*(void **)(polygon_sort_list_15121 + param_1 + 0xe5528),0xc0000);
  return;
}
