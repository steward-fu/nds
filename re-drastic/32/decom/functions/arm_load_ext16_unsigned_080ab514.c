 ...
 *
 * Function : arm_load_ext16_unsigned
 * Address  : 080ab514
 * Program  : drastic
 */


undefined8 arm_load_ext16_unsigned(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  if ((param_1 & 0xfb000000) != 0) {
    ...
    if (iVar1 == 0) {
      ...
      return CONCAT44(unaff_r11[-1].page_allocation_bitmap_coarse[0x4f],(uint)uVar2);
    }
    return CONCAT44(iVar1,(uint)*(ushort *)((param_1 & 0xfffffffe) + iVar1));
  }
  if ((param_1 & 0x7f00) != 0) {
    if (in_OV) {
      uVar3 = 0x10000000;
    ...
    unaff_r11[-1].page_allocation_bitmap_coarse[0x4e] = in_lr;
    unaff_r11[-1].page_allocation_bitmap_coarse[0x4c] = (u32)register0x00000054;
    uVar2 = load_io_register_arm9_16(memory,param_1 & 0x7ffe);
    return CONCAT44(unaff_r11[-1].page_allocation_bitmap_coarse[0x4f],(uint)uVar2);
  }
  return CONCAT44(unaff_r11[-1].page_allocation_bitmap_fine[0xfc0],
                  (uint)*(ushort *)
                         (unaff_r11[-1].page_allocation_bitmap_fine[0xfc0] + (param_1 & 0x7ffe)));
}
