 ...
 *
 * Function : render_polygon_setup_spans_4x
 * Address  : 080c4f88
 * Program  : drastic
 */


void render_polygon_setup_spans_4x(undefined (*param_1) [16],int param_2)

{
  ...
  pauVar4 = param_1 + 0x2c;
  pauVar5 = param_1 + 0x42;
  pauVar6 = param_1 + 0x58;
  pauVar9 = param_1 + 0x16;
  pauVar7 = param_1 + 0xb;
  pauVar8 = param_1 + 0x37;
  pauVar11 = param_1 + 0x4d;
  pauVar12 = param_1 + 99;
  pauVar10 = param_1 + 0x21;
  auVar30 = SIMDExpandImmediate(0,10,2);
  do {
