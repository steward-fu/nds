...
void FUN_00191fcc(long param_1,uint param_2)
...
LAB_00192a24:
        iVar6 = cpu_translate_imm_map_to_logical_isra_0_part_0(uVar18,&iStack_10,&iStack_c);
        if (iVar6 != 0) {
          puVar7 = *(uint **)(param_1 + 0x408);
          uVar18 = iStack_c << 10 | iStack_10 << 0x10 | iVar16 << 5;
          if (bVar5) {
...
LAB_0019225c:
          ...
          if ((uVar18 - 1 < 0xfffffffe) &&
            ...
            **(uint **)(param_1 + 0x408) = iStack_c << 10 | iStack_10 << 0x10 | uVar14 | 0x52000000;
...
LAB_0019268c:
      ...
      if ((uVar18 - 1 < 0xfffffffe) &&
         ...
         iVar6 != 0)) {
        puVar7 = *(uint **)(param_1 + 0x408) + 1;
        **(uint **)(param_1 + 0x408) = iStack_c << 10 | iStack_10 << 0x10 | uVar15 | 0x32000000;
        *(uint **)(param_1 + 0x408) = puVar7;
      }
      else {
        cpu_translate_set_imm32_isra_0(param_1 + 0x408,1,uVar1);
...
LAB_001929dc:
          puVar7 = *(uint **)(param_1 + 0x408);
          uVar15 = iStack_c << 10 | iStack_10 << 0x10 | uVar15;
          if (bVar5) {
...
LAB_00192344:
          ...
          if ((uVar18 - 1 < 0xfffffffe) &&
             ...
             iVar6 != 0)) {
            puVar7 = *(uint **)(param_1 + 0x408) + 1;
            **(uint **)(param_1 + 0x408) = iStack_c << 10 | iStack_10 << 0x10 | uVar15;
            *(uint **)(param_1 + 0x408) = puVar7;
          }
          else {
            cpu_translate_set_imm32_isra_0(param_1 + 0x408,1,uVar1);
