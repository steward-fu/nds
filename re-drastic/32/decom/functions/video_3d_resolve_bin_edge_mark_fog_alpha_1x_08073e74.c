 ...
 *
 * Function : video_3d_resolve_bin_edge_mark_fog_alpha_1x
 * Address  : 08073e74
 * Program  : drastic
 */
...
void video_3d_resolve_bin_edge_mark_fog_alpha_1x
...

{
  ...
  if ((render_target->fog_active == 0) ||
    ...
    if (bin_index == 0) {
      ...
      video_3d_fog_modulate_alpha_resolve_1x(render_target,render_target,puVar7,pgVar11->fog_color);
    ...
    do {
      ...
      video_3d_fog_modulate_alpha_resolve_1x(pvVar5,pvVar5,puVar7,pgVar11->fog_color);
    ...
    if (bin_index == 0xb) {
      ...
      video_3d_fog_modulate_alpha_resolve_1x(puVar10,puVar10,puVar7,pgVar11->fog_color);
