...

{
  ...
  long local_dba0;
  long local_db98;
  undefined auStack_db90 [4];
  undefined auStack_db8c [172];
  undefined auStack_dae0 [1232];
  ushort local_d610 [88];
  ushort local_d560 [88];
  undefined auStack_d4b0 [352];
  undefined auStack_d350 [46816];
  undefined auStack_1c70 [7272];
  long local_8;
  ...
  if ((uVar22 & 0xf) != 0) {
    local_dbd8[0] = (int *)(param_3 + (((ulong)uVar53 & 0xf) + uVar16) * 0x10);
    if (uVar18 != 1) {
      local_dbd8[1] = (int *)(param_3 + (((ulong)(uVar53 >> 4) & 0xf) + uVar16) * 0x10);
      if (uVar18 != 2) {
        local_dbc8 = param_3 + (((ulong)(uVar53 >> 8) & 0xf) + uVar16) * 0x10;
        if (uVar18 != 3) {
          local_dbc0 = (int *)(param_3 + (((ulong)(uVar53 >> 0xc) & 0xf) + uVar16) * 0x10);
          if (uVar18 != 4) {
            local_dbb8 = param_3 + (((ulong)(uVar53 >> 0x10) & 0xf) + uVar16) * 0x10;
            if (uVar18 != 5) {
              local_dbb0 = param_3 + (((ulong)(uVar53 >> 0x14) & 0xf) + uVar16) * 0x10;
              if (uVar18 != 6) {
                local_dba8 = param_3 + (((ulong)(uVar53 >> 0x18) & 0xf) + uVar16) * 0x10;
                if ((uVar18 != 7) &&
                   (local_dba0 = param_3 + ((uVar53 >> 0x1c) + uVar16) * 0x10, uVar18 != 8)) {
                  local_db98 = param_3 + uVar16 * 0x10;
                }
              }
            }
          }
  ...
  piVar11 = local_dbd8[0];
  uVar53 = uVar22 >> 8 & 0x40;
  local_dbd8[uVar18] = local_dbd8[0];
    ...
    if (0 < (int)uVar22) {
      ...
      if ((*(uint *)(polygon_sort_list_15121 + lVar19 + 0xe5500) >> 5 & 1) == 0) {
        ...
        *puVar14 = *puVar14 & 0x7fff;
        ...
        render_polygon_setup_spans_asm_4x(auStack_db90,uVar22);
        render_polygon_setup_4x
                  (param_1,auStack_db90,param_2,auStack_d350,(uVar25 - param_4) + iVar24,uVar22,
                   uVar3,local_dbd8[0]);
      }
      else {
        uVar6 = param_4;
        uVar18 = uVar22;
        local_dc38 = auStack_db90;
        if (bVar8) {
          uVar6 = param_4 - 1;
          uVar18 = uVar22 + 1;
          local_dc38 = auStack_db8c;
        }
        if (uVar53 != 0) {
          uVar18 = uVar18 + 1;
          uVar13 = uVar13 + 1;
        }
        render_polygon_interpolate_edges_constprop_0(auStack_db90);
        render_polygon_interpolate_edges_constprop_1
                  (auStack_dae0,auStack_d4b0,ppiVar2,uVar6,uVar13,uVar3);
        uVar13 = uVar18 - 1;
        if (uVar13 < 8) {
          uVar53 = 0;
        }
                 ...
                 CONCAT17((char)(auVar30._6_2_ >> 8),
                          (uint7)(CONCAT15((char)(uVar33 >> 8),
                                           (uint5)(CONCAT13((char)(uVar32 >> 8),
                                                            (uint3)((byte)(uVar29 >> 8) & 0x82) << 8
                                                           ) & 0x82ffffff)) & 0x82ffffffffff)) &
                 0x82ffffffffffffff;
            auVar35[8] = 0;
            auVar35[9] = (byte)(auVar30._8_2_ >> 8) & 0x82;
            auVar35[10] = 0;
            auVar35[11] = (byte)(auVar30._10_2_ >> 8) & 0x82;
            auVar35[12] = 0;
            auVar35[13] = (byte)(uVar34 >> 8) & 0x82;
            auVar35[14] = 0;
            auVar35[15] = (byte)(puVar12[0xe] >> 8) & 0x82;
            auVar39._0_8_ =
                 CONCAT17((char)(auVar38._6_2_ >> 8),
                          (uint7)(CONCAT15((char)(uVar42 >> 8),
                                           (uint5)(CONCAT13((char)(uVar41 >> 8),
                                                            (uint3)((byte)(uVar37 >> 8) & 0x82) << 8
                                                           ) & 0x82ffffff)) & 0x82ffffffffff)) &
                 0x82ffffffffffffff;
            auVar39[8] = 0;
            auVar39[9] = (byte)(auVar38._8_2_ >> 8) & 0x82;
            auVar39[10] = 0;
            auVar39[11] = (byte)(auVar38._10_2_ >> 8) & 0x82;
            auVar39[12] = 0;
            auVar39[13] = (byte)(uVar43 >> 8) & 0x82;
            auVar39[14] = 0;
            auVar39[15] = (byte)(puVar12[0x66] >> 8) & 0x82;
        ...
        *puVar14 = uVar33;
        if (uVar53 + 1 < uVar18) {
          ...
          uVar33 = uVar32;
          if (uVar32 < uVar29) {
            if ((puVar15[2] & 0x8200) == 0) {
              uVar29 = uVar29 + 1;
            }
          }
          else {
            uVar33 = uVar32 + 1;
            if ((puVar14[2] & 0x8200) != 0) {
              uVar33 = uVar32;
            }
          }
          puVar15[2] = uVar29;
          ...
          if (uVar53 + 2 < uVar18) {
            ...
            uVar33 = uVar32;
            if (uVar32 < uVar29) {
              if ((puVar15[4] & 0x8200) == 0) {
                uVar29 = uVar29 + 1;
              }
            }
            else {
              uVar33 = uVar32 + 1;
              if ((puVar14[4] & 0x8200) != 0) {
                uVar33 = uVar32;
              }
            }
            puVar15[4] = uVar29;
            ...
            if (uVar53 + 3 < uVar18) {
              ...
              uVar33 = uVar32;
              if (uVar32 < uVar29) {
                if ((puVar15[6] & 0x8200) == 0) {
                  uVar29 = uVar29 + 1;
                }
              }
              else {
                uVar33 = uVar32 + 1;
                if ((puVar14[6] & 0x8200) != 0) {
                  uVar33 = uVar32;
                }
              }
              puVar15[6] = uVar29;
              ...
              if (uVar53 + 4 < uVar18) {
                ...
                uVar33 = uVar32;
                if (uVar32 < uVar29) {
                  if ((puVar15[8] & 0x8200) == 0) {
                    uVar29 = uVar29 + 1;
                  }
                }
                else {
                  uVar33 = uVar32 + 1;
                  if ((puVar14[8] & 0x8200) != 0) {
                    uVar33 = uVar32;
                  }
                }
                puVar15[8] = uVar29;
                ...
                if (uVar53 + 5 < uVar18) {
                  ...
                  uVar33 = uVar32;
                  if (uVar32 < uVar29) {
                    if ((puVar15[10] & 0x8200) == 0) {
                      uVar29 = uVar29 + 1;
                    }
                  }
                  else {
                    uVar33 = uVar32 + 1;
                    if ((puVar14[10] & 0x8200) != 0) {
                      uVar33 = uVar32;
                    }
                  }
                  puVar15[10] = uVar29;
                  ...
                  if (uVar53 + 6 < uVar18) {
                    ...
                    uVar33 = uVar32;
                    if (uVar32 < uVar29) {
                      if ((puVar15[0xc] & 0x8200) == 0) {
                        uVar29 = uVar29 + 1;
                      }
                    }
                    else {
                      uVar33 = uVar32 + 1;
                      if ((puVar14[0xc] & 0x8200) != 0) {
                        uVar33 = uVar32;
                      }
                    }
                    puVar15[0xc] = uVar29;
                    ...
                    if (uVar53 + 7 < uVar18) {
                      ...
                      if (uVar32 < uVar29) {
                        uVar33 = uVar29 + 1;
                        if ((puVar15[0xe] & 0x8200) != 0) {
                          uVar33 = uVar29;
                        }
                      }
                      else {
                        uVar34 = uVar32 + 1;
                        if ((puVar14[0xe] & 0x8200) != 0) {
                          uVar34 = uVar32;
                        }
                      }
                      puVar15[0xe] = uVar33;
        ...
        render_polygon_setup_spans_asm_4x(auStack_db90,uVar18);
        render_polygon_setup_edge_markers_c(local_dc38,uVar22,uVar21);
        render_polygon_setup_4x
                  (param_1,extraout_x18,param_2,auStack_d350,(uVar25 - param_4) + iVar24,uVar22,
                   uVar3,local_dbd8[0]);
      }
    }
    goto LAB_001544a0;
  ...
  uVar22 = (uint)uVar32;
  uVar18 = (uint)*(ushort *)((long)local_dbd8[1] + 6);
  uVar53 = (uint)uVar29;
  uVar13 = uVar22;
  if (uVar53 == *(ushort *)((long)local_dbd8[1] + 6)) {
    uVar33 = *(ushort *)(local_dbd8[1] + 1);
    uVar25 = (uint)uVar33;
    piVar7 = local_dbd8[1];
    if (uVar33 <= uVar32) goto LAB_00154528;
    uVar18 = (uint)*(ushort *)((long)local_dbc0 + 6);
  }
  else {
    uVar33 = *(ushort *)(local_dbc0 + 1);
    piVar7 = local_dbc0;
    uVar25 = (uint)uVar33;
    if (uVar33 <= uVar32) {
LAB_00154528:
      piVar11 = piVar7;
      uVar18 = (uint)*(ushort *)(local_dbc8 + 6);
      uVar13 = (uint)uVar33;
      uVar25 = uVar22;
    }
  }
  ...
  if (uVar53 != 0) {
    ...
    if (uVar25 * uVar53 < 0x401) {
      render_sprite_block_4x_isra_0
                (param_1,param_2 + 4,*(undefined8 *)(param_2 + 0x10),auStack_d350,uVar13,iVar26,
                 (int)sVar4 >> 4,iVar23,uVar25,uVar53,iVar24,uVar10,uVar3);
    }
    else {
      uVar18 = 0;
      if (uVar25 != 0) {
        uVar18 = (uVar25 + 0x3ff) / uVar25;
      }
      do {
        if (uVar53 < uVar18) {
          uVar18 = uVar53;
...
LAB_001544a0:
  ...
  __stack_chk_fail(auStack_1c70,local_8 - ___stack_chk_guard,0);
}
