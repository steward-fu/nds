 ...
 *
 * Function : render_polygon_edge_perspective_coefficients
 * Address  : 080c2bb8
 * Program  : drastic
 */


void render_polygon_edge_perspective_coefficients
               (undefined8 *param_1,int **param_2,byte *param_3,int param_4,undefined4 param_5)
