...
void FUN_001f4ecc(long param_1,long *param_2)
  ...
  if ((*(byte *)((long)pplVar5 + 0x42) >> 1 & 1) != 0) {
    ...
    if (bVar1 != 0) {
      ...
      do {
        if (param_2 == **(long ***)(lVar2 + 0x20 + uVar4 * 8)) {
          ...
          puStack_10 = &DAT_002296a8;
          if (lVar2 != 0) {
            puStack_10 = (undefined1 *)(lVar2 + 0x20);
          }
          goto LAB_001f4f6c;
        }
        uVar4 = uVar4 + 1;
    ...
    if ((-1 < (long)param_2 - (long)pplVar5[4] && param_2 < pplVar5[1]) &&
       (pcVar3 = (char *)getobjname(*(long *)(lVar2 + 0x18),
                                    ...
                                    &puStack_10), pcVar3 != (char *)0x0)) {
LAB_001f4f6c:
      pcVar3 = (char *)luaO_pushfstring(param_1," (%s \'%s\')",pcVar3,puStack_10);
      goto LAB_001f4fd0;
    }
  }
  pcVar3 = "";
LAB_001f4fd0:
  ...
  __stack_chk_fail(pcVar3,lStack_8 - ___stack_chk_guard,0);
}
