...
void FUN_0013862c(long param_1,long param_2,long param_3)
...
LAB_00138868:
    uStack_30 = CONCAT44(uVar60,uVar35);
    uStack_20 = CONCAT44(uVar56,uVar30);
                                           ...
                                           CONCAT13(~(byte)((ulong)uStack_28 >> 0x18),
                                                    CONCAT12(~(byte)((ulong)uStack_28 >> 0x10),
                                                             CONCAT11(~(byte)((ulong)uStack_28 >> 8)
                                                                      ,~(byte)uStack_28)))))));
  *(ulong *)(param_3 + 0xa0) =
       CONCAT17(~(byte)((ulong)uStack_30 >> 0x38),
                CONCAT16(~(byte)((ulong)uStack_30 >> 0x30),
                         CONCAT15(~(byte)((ulong)uStack_30 >> 0x28),
                                  CONCAT14(~(byte)((ulong)uStack_30 >> 0x20),
                                           CONCAT13(~(byte)((ulong)uStack_30 >> 0x18),
                                                    CONCAT12(~(byte)((ulong)uStack_30 >> 0x10),
                                                             CONCAT11(~(byte)((ulong)uStack_30 >> 8)
                                                                      ,~(byte)uStack_30)))))));
  *(ulong *)(param_3 + 0xb8) =
                                           ...
                                           CONCAT13(~(byte)((ulong)uStack_18 >> 0x18),
                                                    CONCAT12(~(byte)((ulong)uStack_18 >> 0x10),
                                                             CONCAT11(~(byte)((ulong)uStack_18 >> 8)
                                                                      ,~(byte)uStack_18)))))));
  *(ulong *)(param_3 + 0xb0) =
       CONCAT17(~(byte)((ulong)uStack_20 >> 0x38),
                CONCAT16(~(byte)((ulong)uStack_20 >> 0x30),
                         CONCAT15(~(byte)((ulong)uStack_20 >> 0x28),
                                  CONCAT14(~(byte)((ulong)uStack_20 >> 0x20),
                                           CONCAT13(~(byte)((ulong)uStack_20 >> 0x18),
                                                    CONCAT12(~(byte)((ulong)uStack_20 >> 0x10),
                                                             CONCAT11(~(byte)((ulong)uStack_20 >> 8)
                                                                      ,~(byte)uStack_20)))))));
  if (lVar19 != 0) {
