 ...
 *
 * Function : _ZN5RarVM21FilterItanium_SetBitsEPhjii
 * Address  : 0810bec4
 * Program  : drastic
 */


/* DWARF original prototype: void FilterItanium_SetBits(RarVM * this, byte * Data, uint BitField,
   int BitPos, int BitCount) */

void __thiscall
RarVM::FilterItanium_SetBits(RarVM *this,byte *Data,uint BitField,int BitPos,int BitCount)
