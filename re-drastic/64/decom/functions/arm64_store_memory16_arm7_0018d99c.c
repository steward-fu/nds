 ...
 *
 * Function : arm64_store_memory16_arm7
 * Address  : 0018d99c
 * Program  : drastic64
 */


ulong arm64_store_memory16_arm7(ulong param_1,short param_2)

{
      ...
      if ((int)uVar8 != 0) {
        ...
        *(undefined4 *)(unaff_x28 + 0x23bc) = uVar7;
        ...
        nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018db1c. Too many branches */
  ...
  *(undefined4 *)(unaff_x28 + 0x2290) = in_w12;
  store_io_register_arm7_16(*(undefined8 *)(unaff_x28 + 0x2260),uVar6 & 0xfffffe,param_2);
