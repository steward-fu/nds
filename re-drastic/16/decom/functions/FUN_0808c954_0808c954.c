...
void FUN_0808c954(int param_1,undefined *param_2,undefined8 *param_3,int param_4)

{
  ...
  uVar7 = *(ushort *)(param_1 + 0x72);
  uVar19 = (uint)*(ushort *)(param_1 + 0x74) + param_4;
  ...
  iVar16 = *(int *)(param_1 + 0x18) + iVar16;
  local_f0 = *puVar13;
  uStack_ec = puVar13[1];
  uStack_e0 = puVar13[4];
  local_dc = puVar13[5];
  ...
  if ((uVar8 & 0x80) != 0) {
    ...
    puStack_6c = param_3;
    FUN_0808c8b0(param_2 + -0x200,param_2 + -0x200 + local_68 * 2,iVar18,0xff);
