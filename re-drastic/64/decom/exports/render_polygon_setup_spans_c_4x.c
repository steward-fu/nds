 ...
 *
 * Function : render_polygon_setup_spans_c_4x
 * Address  : 00153dd0
 * Program  : drastic64
 */


void render_polygon_setup_spans_c_4x(long param_1,int param_2)

{
  ...
  if (param_2 != 0) {
    do {
      ...
      if (0x200 < uVar7) {
        *(undefined2 *)(piVar8 + 0x134) = 0x200;
      }
      if (0x200 < uVar6) {
        *(undefined2 *)(piVar8 + 0x160) = 0x200;
      }
