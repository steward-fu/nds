 ...
 *
 * Function : arm_store_block4_arm7
 * Address  : 080ad3c4
 * Program  : drastic
 */


u32 * arm_store_block4_arm7(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  if ((uVar3 >> 0x1e & 2) != 0) {
    ...
    *puVar2 = *puVar1;
    ...
    puVar1 = (u32 *)cpu_block_check_allocation_block4
    ...
    if (((uint)puVar1 & 1) != 0) {
      ...
      UNRECOVERED_JUMPTABLE =
           (code *)cpu_block_lookup_base
                             ((cpu_struct *)(unaff_r11[-1].page_allocation_bitmap_fine + 0x7a0),
                              uVar7);
                    /* WARNING: Could not recover jumptable at 0x080ad53c. Too many branches */
