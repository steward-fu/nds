 ...
 *
 * Function : arm_store_block16_arm7
 * Address  : 080ae9b4
 * Program  : drastic
 */


u32 * arm_store_block16_arm7(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  if (!(bool)((byte)(unaff_r11->page_table[param_1 >> 0xb] >> 0x1e) & 1)) {
    ...
    *puVar2 = *puVar1;
    ...
    puVar2[6] = unaff_r11[-1].page_allocation_bitmap_coarse[0x56];
    puVar2[7] = unaff_r11[-1].page_allocation_bitmap_coarse[0x57];
    puVar2[8] = unaff_r11[-1].page_allocation_bitmap_coarse[0x58];
    puVar2[9] = unaff_r11[-1].page_allocation_bitmap_coarse[0x59];
    puVar2[10] = unaff_r11[-1].page_allocation_bitmap_coarse[0x5a];
    puVar2[0xb] = unaff_r11[-1].page_allocation_bitmap_coarse[0x5b];
    puVar2[0xc] = unaff_r11[-1].page_allocation_bitmap_coarse[0x5c];
    puVar2[0xd] = unaff_r11[-1].page_allocation_bitmap_coarse[0x5d];
    puVar2[0xe] = unaff_r11[-1].page_allocation_bitmap_coarse[0x5e];
    puVar2[0xf] = unaff_r11[-1].page_allocation_bitmap_coarse[0x5f];
    return puVar2 + 0x10;
  }
  ...
  if ((uVar3 >> 0x1e & 2) != 0) {
    ...
    *puVar2 = *puVar1;
    ...
    puVar1 = (u32 *)cpu_block_check_allocation_block16
    ...
    if (((uint)puVar1 & 1) != 0) {
      ...
      UNRECOVERED_JUMPTABLE =
           (code *)cpu_block_lookup_base
                             ((cpu_struct *)(unaff_r11[-1].page_allocation_bitmap_fine + 0x7a0),
                              uVar7);
                    /* WARNING: Could not recover jumptable at 0x080aebec. Too many branches */
