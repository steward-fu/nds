 ...
 *
 * Function : FUN_080452a0
 * Address  : 080452a0
 * Program  : drastic16
 */


/* WARNING: Removing unreachable block (ram,0x08045314) */

void FUN_080452a0(int param_1,int param_2)

{
  ...
  if ((*(int *)(param_1 + 0x900c) != 0) && (*(int *)(*(int *)(param_1 + 0x9000) + 0x1807c8) != 0)) {
    ...
    do {
      ...
      iVar3 = iVar2 + 0x400;
      iVar5 = iVar5 + 0x400;
      FUN_08092bbc(iVar2,param_1,auStack_130,*(undefined4 *)(iVar4 + 0x9a64));
