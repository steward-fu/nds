 ...
 *
 * Function : arm_load_block16
 * Address  : 080ace70
 * Program  : drastic
 */


u32 * arm_load_block16(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  unaff_r11[-1].page_allocation_bitmap_coarse[0x5b] = puVar1[0xb];
  unaff_r11[-1].page_allocation_bitmap_coarse[0x5c] = puVar1[0xc];
  unaff_r11[-1].page_allocation_bitmap_coarse[0x5d] = puVar1[0xd];
  unaff_r11[-1].page_allocation_bitmap_coarse[0x5e] = puVar1[0xe];
  unaff_r11[-1].page_allocation_bitmap_coarse[0x5f] = puVar1[0xf];
  return unaff_r11[-1].page_allocation_bitmap_coarse + 0x50;
}
