 ...
 *
 * Function : FUN_0020344c
 * Address  : 0020344c
 * Program  : drastic64
 */


void FUN_0020344c(long param_1,int param_2)
        ...
        if ((uVar3 == 4) && (*(long *)(*(long *)(lVar6 + -0x20) + 0x10) == 0)) {
          ...
          *(undefined8 *)(lVar6 + -0x18) = *(undefined8 *)(lVar6 + -8);
          ...
          if (param_2 < 2) {
            ...
            lVar7 = (1 - lVar4) * 0x10;
            lStack_8 = -(-(ulong)(uVar1 >> 0x1f) & 0xfffffff000000000 | (ulong)uVar1 << 4);
            uVar3 = uVar1;
          }
LAB_0020360c:
          ...
          *(long *)(lVar6 + lStack_8) = lVar9;
          *(uint *)(lVar6 + lStack_8 + 8) = *(byte *)(lVar9 + 8) | 0x40;
        }
        goto LAB_002034b8;
      }
      param_2 = param_2 + -1;
