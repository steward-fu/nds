...

{
  ...
  *(undefined4 *)(param_2 + 0xc02c) = 0;
  ...
  if (uVar8 == 0) {
    ...
    local_3c = param_5 | 4;
    local_38 = param_1 + 0x9000;
    uVar21 = 0;
    uVar22 = 0xffffffff;
    local_ac = 0xffffffff;
    uVar26 = 0;
    local_20 = &completed_9126;
    puVar18 = &polygon_sort_counts_13777;
...
LAB_0014f630:
      ...
      *(short *)(lVar10 + 0x16) = (short)uVar8;
      ...
      if (((uVar4 & 0x1c000000) != 0) && ((puVar27[1] >> 4 & 3) != 3)) {
        ...
        uVar12 = uVar14 | 2;
        if (uVar4 != local_ac || uVar16 != uVar22) {
...
LAB_0014f9e4:
  puVar17 = (undefined1 *)0x4aa640;
  psVar19 = (short *)(local_20 + 800);
  do {
    iVar9 = *psVar19 + -1;
    lVar10 = (long)iVar9;
    while (-1 < iVar9) {
      ...
      if (0xc0 < param_3[(ulong)uVar16 * 8 + 2] >> 0x17) {
        uVar7 = 0xc0;
      }
      sVar2 = *(short *)(local_20 + uVar7 * 2 + 0x1a0);
      *(short *)(local_20 + uVar7 * 2 + 0x1a0) = *(short *)(local_20 + uVar7 * 2 + 0x1a0) + 1;
      *(ushort *)(polygon_sort_list_13776 + ((long)sVar2 + uVar7 * 0x800) * 2) = uVar16;
      iVar9 = (int)lVar10;
    }
    *psVar19 = 0;
    bVar3 = puVar17 != polygon_sort_list_13776;
    puVar17 = puVar17 + -0x1000;
    psVar19 = psVar19 + -1;
  } while (bVar3);
  lVar10 = 0x3eb640;
  puVar18 = (undefined2 *)(local_20 + 0x1a0);
  lVar6 = 0;
  do {
    ...
    while (-1 < iVar9) {
      ...
      uVar8 = 0xfff << (ulong)(*(ushort *)
                                ...
                                6) >> 4 & 0x1f) & 0xfffU >> (ulong)(0xb - ((uint)lVar6 >> 4) & 0x1f)
      ;
      if ((uVar8 & 1) != 0) {
