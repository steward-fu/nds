 ...
 *
 * Function : render_polygon_writeback_all_pass_asm_4x
 * Address  : 0019c8b0
 * Program  : drastic64
 */


void render_polygon_writeback_all_pass_asm_4x
...

{
  ...
  iVar7 = iVar7 + 8;
                    /* WARNING: Could not recover jumptable at 0x0019c938. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&UNK_0019c9e4 + (long)iVar7 * 4))
            (CONCAT13((byte)((uint)*param_7 >> 0x18) | param_5,(int3)*param_7),
             ...
             param_6 + iVar7,param_7 + iVar7,(0x200 - (uint)uVar2) - uVar5);
  return;
}
