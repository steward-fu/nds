 ...
 *
 * Function : FUN_00181f3c
 * Address  : 00181f3c
 * Program  : drastic64
 */


void FUN_00181f3c(long param_1)
  ...
  if ((*(int *)(param_1 + 0x438) != 0) &&
    ...
    do {
      ...
      while( true ) {
        ...
        if (*(uint *)(param_1 + 0x46c) <= uStack_14) goto LAB_00181f68;
        plVar8 = (long *)(*(long *)(param_1 + 0x458) + (ulong)uStack_14 * 0x28);
        uVar6 = *(uint *)((long)plVar8 + 0x1c);
        if (uVar6 != uStack_10) break;
LAB_001821e8:
        pcVar9 = "  ";
        if (!bVar5) {
          pcVar9 = "";
