...
void render_polygon_4x(video_3d_render_target_struct *render_target,geometry_polygon_struct *polygon
...

{
  ...
  s32 *buffer_data_00;
  u8 *buffer_data;
  s32 in_stack_ffff23d0;
  u32 in_stack_ffff23d4;
  u32 buffered_min_y;
  u32 local_dbf8;
  int local_dbf4;
  geometry_vertex_struct **local_dbec;
  geometry_struct *local_dbe4;
  geometry_vertex_struct *bottom_vertex;
  geometry_vertex_struct *local_dbd8;
  geometry_vertex_struct *local_dbd4;
  geometry_vertex_struct *local_dbd0;
  geometry_vertex_struct *local_dbcc;
  geometry_vertex_struct *local_dbc8;
  geometry_vertex_struct *local_dbc4;
  geometry_vertex_struct *local_dbc0;
  geometry_vertex_struct *local_dbbc;
  u64 _aligned_storage [7025];
  ...
  if (uVar12 != 0) {
    ...
    if (uVar12 != 1) {
      local_dbd8 = base_vertexes + (uVar8 >> 4 & 0xf) + uVar5;
      if (uVar12 != 2) {
        local_dbd4 = base_vertexes + (uVar8 >> 8 & 0xf) + uVar5;
        if (uVar12 != 3) {
          local_dbd0 = base_vertexes + (uVar8 >> 0xc & 0xf) + uVar5;
          if (uVar12 != 4) {
            local_dbcc = base_vertexes + (uVar8 >> 0x10 & 0xf) + uVar5;
            if (uVar12 != 5) {
              local_dbc8 = base_vertexes + (uVar8 >> 0x14 & 0xf) + uVar5;
              if (uVar12 != 6) {
                local_dbc4 = base_vertexes + (uVar8 >> 0x18 & 0xf) + uVar5;
                if ((uVar12 != 7) &&
                   (local_dbc0 = base_vertexes + (uVar8 >> 0x1c) + uVar5, uVar12 != 8)) {
                  local_dbbc = base_vertexes + uVar5;
                }
              }
            }
          }
  ...
  if ((uVar17 >> 8 & 0x40) == 0) {
    uVar13 = uVar16 - uVar5;
    if (uVar5 < min_y) {
      local_dbf4 = min_y - uVar5;
      uVar13 = uVar13 - local_dbf4;
      local_dbf8 = 3;
    }
    else {
      local_dbf8 = 2;
      ...
      if (((pvVar14->video_3d).display_3d_control & 0x20) == 0) {
        ...
        render_polygon_interpolate_edges
                  (geometry,(u8 *)psVar9,(u8 *)&bottom_vertex,(geometry_vertex_struct **)min_y,
                   uVar16,(u32)polygon_1,in_stack_ffff23d0,in_stack_ffff23d4);
        render_polygon_interpolate_edges
                  ((geometry_struct *)((geometry->primitive_queue).input_x + 0x2c),(u8 *)psVar9,
                   ...
                   (u32)polygon_1,in_stack_ffff23d0,in_stack_ffff23d4);
        uVar15 = 0;
        ...
        render_polygon_setup_spans_4x(geometry,uVar13);
        render_polygon_setup_4x
                  (render_target,(u8 *)geometry,polygon,(u8 *)buffer_data_00,
                   (uVar5 - min_y) + local_dbf4,uVar13,(u32)polygon_1,bottom_vertex);
      }
      else {
        uVar15 = uVar13;
        local_dbec = (geometry_vertex_struct **)min_y;
        local_dbe4 = geometry;
        if (uVar17 != 0) {
          local_dbec = (geometry_vertex_struct **)(min_y - 1);
          uVar15 = uVar13 + 1;
          local_dbe4 = (geometry_struct *)((geometry->primitive_queue).input_x + 1);
        }
        if (bVar1) {
          uVar16 = uVar16 + 1;
          uVar15 = uVar15 + 1;
        ...
        psVar9 = (geometry->primitive_queue).transformed_coordinates + 0x28;
        render_polygon_interpolate_edges
                  (geometry,(u8 *)psVar9,(u8 *)&bottom_vertex,local_dbec,uVar16,(u32)polygon_1,
                   in_stack_ffff23d0,in_stack_ffff23d4);
        render_polygon_interpolate_edges
                  ((geometry_struct *)((geometry->primitive_queue).input_x + 0x2c),(u8 *)psVar9,
                   (u8 *)(&bottom_vertex + uVar12),local_dbec,uVar16,(u32)polygon_1,
                   in_stack_ffff23d0,in_stack_ffff23d4);
        uVar6 = 0;
        puVar10 = (geometry->primitive_queue).input_uv + 0x1a;
        do {
          ...
          if (uVar7 < uVar4) {
            if ((*(ushort *)(puVar10 + -1) & 0x8200) == 0) {
              uVar4 = uVar4 + 1;
            }
          }
          else if ((*(ushort *)(puVar10 + 0x2b) & 0x8200) == 0) {
            uVar7 = uVar7 + 1;
          }
          uVar6 = uVar6 + 1;
        ...
        render_polygon_setup_spans_4x(geometry);
        render_polygon_setup_edge_markers((u8 *)local_dbe4,uVar13,local_dbf8);
        render_polygon_setup_4x
                  (render_target,(u8 *)local_dbe4,polygon,(u8 *)buffer_data_00,
                   (uVar5 - min_y) + local_dbf4,uVar13,(u32)polygon_1,bottom_vertex);
      }
    }
  }
  else {
    uVar12 = (uint)local_dbd8->y;
    pgVar11 = bottom_vertex;
    if (uVar5 == uVar12) {
      uVar17 = (uint)local_dbd8->x;
      uVar16 = (uint)bottom_vertex->x;
      if (uVar16 < uVar17) {
        uVar12 = (uint)local_dbd0->y;
        uVar8 = uVar17;
        uVar17 = uVar16;
      }
      else {
        uVar12 = (uint)local_dbd4->y;
        pgVar11 = local_dbd8;
        uVar8 = uVar16;
      }
    }
    ...
    if (uVar16 != 0) {
      ...
      v_00 = (int)sVar2 >> 4;
      if (uVar16 * height_00 < 0x401) {
        render_sprite_block_4x
        ...
        lines = __aeabi_uidiv(height_00 + 0x3ff,height_00);
        u = uVar5 - min_y;
        do {
          if (uVar16 <= lines) {
            lines = uVar16;
