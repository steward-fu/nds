 ...
 *
 * Function : video_3d_edge_identify_c_4x
 * Address  : 00156170
 * Program  : drastic64
 */


void video_3d_edge_identify_c_4x
...

{
  ...
  do {
    while( true ) {
      ...
      lVar6 = lVar6 + 1;
      if (lVar6 == 0x1fe) goto LAB_001562a8;
    }
...
LAB_001562a8:
  ...
  if ((uVar3 >> 0x1e & 1) != 0) {
    uVar2 = uVar3 >> 0x18 & 0x7f ^ 0x40;
    uVar3 = uVar3 & 0xffffff;
    bVar1 = -((param_3[0x1fe] >> 0x18 & 0x3f) == uVar2 || (param_3[0x1fe] & 0xffffff) <= uVar3);
    if ((uVar5 & 0x3f) != uVar2 && uVar3 < ((uint)param_5 & 0xffffff)) {
      bVar1 = 0;
    }
    if ((param_2[0x1ff] >> 0x18 & 0x3f) != uVar2 && uVar3 < (param_2[0x1ff] & 0xffffff)) {
      bVar1 = 0;
    }
    if ((param_4[0x1ff] >> 0x18 & 0x3f) != uVar2 && uVar3 < (param_4[0x1ff] & 0xffffff)) {
      bVar1 = 0;
    }
    param_1[0x1ff] = bVar1 | (byte)(uVar2 >> 3);
    return;
  }
  param_1[0x1ff] = 0xff;
  return;
