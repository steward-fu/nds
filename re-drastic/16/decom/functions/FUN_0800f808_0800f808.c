 ...
 *
 * Function : FUN_0800f808
 * Address  : 0800f808
 * Program  : drastic16
 */


void FUN_0800f808(int param_1,uint param_2,undefined2 param_3)

{
  ...
  if (param_2 < 0x10000000) {
    ...
    if (cVar1 == '\x01') {
      puVar2 = (undefined2 *)(**(code **)(iVar4 + 0x10))(*(undefined4 *)(param_1 + 0x800004));
      if (*(char *)(iVar4 + 0x2c) == *(char *)(iVar4 + 0x2d)) {
        ...
        *(uint *)(param_1 + (uVar5 >> 0xb) * 4) = (int)puVar2 + (-uVar5 - (param_2 & 0x7ff)) >> 2;
      }
      *puVar2 = param_3;
      return;
    }
    if (cVar1 == '\0') {
      ...
      *(undefined2 *)(iVar3 + (uVar5 & param_2)) = param_3;
      return;
    }
    if (cVar1 == '\x02') {
      (**(code **)(iVar4 + 0x14))
