 ...
 *
 * Function : render_scanline_affine_setup_map_indexes_extended
 * Address  : 080bd630
 * Program  : drastic
 */
...
render_scanline_affine_setup_map_indexes_extended
          (undefined (*param_1) [16],short *param_2,int param_3,uint param_4,uint param_5,
          undefined2 param_6,undefined2 param_7,int param_8,byte param_9)

{
  ...
  *param_2 = ((ushort)(param_4 >> 10) & (ushort)(param_8 * 2)) +
             (short)((param_5 >> 10 & param_8 * 2) << (uint)param_9);
  pauVar5 = param_1 + 1;
  ...
  VectorShiftRight(auVar19,2);
  VectorShiftRight(auVar12,2);
  VectorShiftNarrowRight(auVar10,2);
  VectorShiftNarrowRight(auVar11,2);
  iVar7 = param_3 + -0x10;
  if (param_3 + -0x10 != 0 && 0xf < param_3) {
    do {
      ...
      *puVar6 = auVar19._0_8_;
      ...
      VectorShiftRight(auVar20,2);
      VectorShiftRight(auVar21,2);
      VectorShiftNarrowRight(auVar13,2);
      VectorShiftNarrowRight(auVar14,2);
      iVar8 = iVar7 + -0x10;
      bVar1 = 0xf < iVar7;
      iVar7 = iVar8;
    } while (iVar8 != 0 && bVar1);
