 ...
 *
 * Function : arm_store_block1_arm9
 * Address  : 080acfb0
 * Program  : drastic
 */


u32 * arm_store_block1_arm9(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  if ((uVar3 >> 0x1e & 2) != 0) {
    ...
    *(u32 *)(address + uVar3 * 4) = *puVar1;
    ...
    puVar1 = (u32 *)cpu_block_check_allocation_block1
    ...
    if (((uint)puVar1 & 1) != 0) {
      ...
      UNRECOVERED_JUMPTABLE =
           (code *)cpu_block_lookup_base
                             ((cpu_struct *)(unaff_r11[-1].page_allocation_bitmap_fine + 0x7a0),
                              uVar7);
                    /* WARNING: Could not recover jumptable at 0x080ad0f8. Too many branches */
