 ...
 *
 * Function : video_3d_resolve_bin_edge_mark_fog_full_4x
 * Address  : 080770d0
 * Program  : drastic
 */
...
void video_3d_resolve_bin_edge_mark_fog_full_4x
...

{
  ...
  if ((render_target->fog_active == 0) ||
    ...
    if (bin_index == 0) {
      ...
      video_3d_fog_modulate_full_intermediate_4x
    ...
    do {
      ...
      video_3d_fog_modulate_full_intermediate_4x(pvVar5,pvVar5,puVar7,pgVar11->fog_color);
    ...
    if (bin_index == 0xb) {
      ...
      video_3d_fog_modulate_full_intermediate_4x(puVar10,puVar10,puVar7,pgVar11->fog_color);
