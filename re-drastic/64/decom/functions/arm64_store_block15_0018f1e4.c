 ...
 *
 * Function : arm64_store_block15
 * Address  : 0018f1e4
 * Program  : drastic64
 */


void arm64_store_block15(ulong param_1)

{
  ...
  if ((uVar5 >> 0x3e & 1) == 0) {
    ...
    uVar7 = *(undefined8 *)(in_x9 + -0x110);
    uVar8 = *(undefined8 *)(in_x9 + -0x108);
    *puVar1 = *(undefined8 *)(in_x9 + -0x120);
    puVar1[1] = uVar6;
    puVar1[2] = uVar7;
    puVar1[3] = uVar8;
    uVar6 = *(undefined8 *)(in_x9 + -0xf8);
    puVar1[4] = *(undefined8 *)(in_x9 + -0x100);
    puVar1[5] = uVar6;
    uVar4 = *(undefined4 *)(in_x9 + -0xec);
    *(undefined4 *)(puVar1 + 6) = *(undefined4 *)(in_x9 + -0xf0);
    *(undefined4 *)((long)puVar1 + 0x34) = uVar4;
    *(undefined4 *)(puVar1 + 7) = *(undefined4 *)(in_x9 + -0xe8);
    return;
  }
  if (-1 < (long)uVar5) {
  ...
  *(uint *)(unaff_x28 + 0x2334) = uVar2;
  iVar3 = cpu_block_check_allocation_block15();
  if (iVar3 == 0) {
  ...
  *(undefined4 *)(unaff_x28 + 0x23bc) = uVar4;
  ...
  nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018f314. Too many branches */
