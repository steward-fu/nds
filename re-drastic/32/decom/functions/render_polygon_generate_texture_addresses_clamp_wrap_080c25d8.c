 ...
 *
 * Function : render_polygon_generate_texture_addresses_clamp_wrap
 * Address  : 080c25d8
 * Program  : drastic
 */


void render_polygon_generate_texture_addresses_clamp_wrap
  ...
  do {
    ...
    *param_1 = auVar8._0_8_;
    ...
    param_3 = iVar4 + -8;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080c2640. Too many branches */
