...
uint FUN_0018b9bc(long param_1,uint *param_2)
...
LAB_0018ba28:
  do {
    iVar4 = SDL_PollEvent(auStack_40);
    while( true ) {
      if (iVar4 == 0) {
        if (uVar7 == 0xb) {
          if (*(char *)((long)&gui_actions + (ulong)cursor_repeat_37536) != '\0') {
            get_ticks_us(&lStack_48);
            if (button_repeat_state_37535 == 1) {
              if (250000 < (ulong)(lStack_48 - button_repeat_timestamp_37534)) {
                button_repeat_timestamp_37534 = lStack_48;
                button_repeat_state_37535 = 2;
                uVar7 = cursor_repeat_37536;
              }
            }
            else if ((button_repeat_state_37535 == 2) &&
                    (50000 < (ulong)(lStack_48 - button_repeat_timestamp_37534))) {
              uVar7 = cursor_repeat_37536;
              button_repeat_timestamp_37534 = lStack_48;
            }
          }
      ...
      if (auStack_40[0] == 0x602) break;
      if (0x602 < auStack_40[0]) {
        if (auStack_40[0] == 0x603) {
          uVar9 = *(ulong *)(lVar10 + (long)(int)((uStack_38 & 3) << 8 | (uint)bStack_34 | 0x400) *
                                      8);
          uVar7 = 0;
...
LAB_0018bd50:
      ...
      if (auStack_40[0] == 0x301) {
        uVar9 = *(ulong *)(lVar10 + (long)(int)(((int)uStack_2c >> 0x1e & 3U) << 8 |
                                               uStack_2c & 0xff) * 8);
        uVar6 = 0;
        if ((uVar9 & 0x80000000) == 0) {
          uVar6 = 0xb;
      ...
      if (auStack_40[0] != 0x600) {
        if (auStack_40[0] != 0x300) goto LAB_0018ba28;
        uVar9 = *(ulong *)(lVar10 + (long)(int)(((int)uStack_2c >> 0x1e & 3U) << 8 |
                                               uStack_2c & 0xff) * 8);
        uVar7 = 0;
        if ((uVar9 & 0x80000000) == 0) {
...
LAB_0018bc9c:
      ...
      uVar3 = (uint)bStack_34 * 2;
      uVar6 = *(uint *)(SDL_input + (ulong)uStack_38 * 4) &
      ...
      uVar2 = (uStack_38 & 3) << 8 | (uint)bStack_34;
      ...
      if (*(uint *)(SDL_input + (ulong)uStack_38 * 4) == uVar5) goto LAB_0018ba28;
      ...
      *(undefined *)((long)&gui_actions + (ulong)uVar7) = 1;
      *(uint *)(SDL_input + (ulong)uStack_38 * 4) = uVar5;
      iVar4 = SDL_PollEvent(auStack_40);
    }
    uVar3 = (uStack_38 & 3) << 8;
