 ...
 *
 * Function : arm64_store_block16
 * Address  : 0018f318
 * Program  : drastic64
 */


void arm64_store_block16(ulong param_1)

{
  ...
  if ((uVar5 >> 0x3e & 1) == 0) {
    ...
    *puVar1 = *(undefined8 *)(in_x9 + -0x120);
    ...
    uVar7 = *(undefined8 *)(in_x9 + -0xf0);
    uVar8 = *(undefined8 *)(in_x9 + -0xe8);
  ...
  *(uint *)(unaff_x28 + 0x2334) = uVar2;
  iVar3 = cpu_block_check_allocation_block16();
  if (iVar3 == 0) {
  ...
  *(undefined4 *)(unaff_x28 + 0x23bc) = uVar4;
  ...
  nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018f438. Too many branches */
