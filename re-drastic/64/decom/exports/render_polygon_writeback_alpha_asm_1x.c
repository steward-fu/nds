 ...
 *
 * Function : render_polygon_writeback_alpha_asm_1x
 * Address  : 0019b620
 * Program  : drastic64
 */


void render_polygon_writeback_alpha_asm_1x
    ...
    do {
      ...
      *puVar3 = uVar25;
      ...
      iVar7 = iVar8;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0019b6a8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
  (*(code *)(&UNK_0019b788 + (long)(iVar8 + 8) * 4))
            ((0x100 - (uint)uVar2) - uVar6,*param_7,param_7[4],*param_6,param_6[4],*param_8,
             param_1 + 0x584);
  return;
}
