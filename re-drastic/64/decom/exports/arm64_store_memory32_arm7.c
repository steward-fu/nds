 ...
 *
 * Function : arm64_store_memory32_arm7
 * Address  : 0018db20
 * Program  : drastic64
 */


ulong arm64_store_memory32_arm7(ulong param_1,int param_2)

{
  ...
  lVar1 = uVar9 * 4;
  if ((uVar9 >> 0x3e & 1) == 0) {
    *(int *)(lVar1 + uVar8) = param_2;
    return uVar8;
  }
  if (uVar6 >> 0x18 != 4) {
    if ((long)uVar9 < 0) {
      if (param_2 == *(int *)(lVar1 + uVar8)) {
        return uVar8;
      }
      *(int *)(lVar1 + (ulong)uVar2) = param_2;
      ...
      *(int *)(unaff_x28 + 0x2354) = (int)uVar10;
      uVar8 = cpu_block_check_allocation32();
      if ((int)uVar8 != 0) {
        ...
        *(undefined4 *)(unaff_x28 + 0x23bc) = uVar7;
        ...
        nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018dca0. Too many branches */
  ...
  *(undefined4 *)(unaff_x28 + 0x2290) = in_w12;
  store_io_register_arm7_32(*(undefined8 *)(unaff_x28 + 0x2260),uVar6 & 0xfffffc,param_2);
