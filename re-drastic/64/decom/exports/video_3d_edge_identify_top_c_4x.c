 ...
 *
 * Function : video_3d_edge_identify_top_c_4x
 * Address  : 00155e10
 * Program  : drastic64
 */


void video_3d_edge_identify_top_c_4x(byte *param_1,uint *param_2,uint *param_3,undefined8 param_4)

{
  ...
  do {
    while( true ) {
      ...
      lVar6 = lVar6 + 1;
      if (lVar6 == 0x1fe) goto LAB_00155f30;
    }
...
LAB_00155f30:
  ...
  if ((uVar2 >> 0x1e & 1) != 0) {
    ...
    bVar7 = -((param_2[0x1fe] >> 0x18 & 0x3f) == uVar1 || (param_2[0x1fe] & 0xffffff) <= uVar2);
    if (uVar2 < (uVar5 & 0xffffff) && uVar4 != uVar1) {
      bVar7 = 0;
    }
    if ((param_3[0x1ff] >> 0x18 & 0x3f) != uVar1 && uVar2 < (param_3[0x1ff] & 0xffffff)) {
      bVar7 = 0;
    }
