...
void store_memory32(memory_interface_struct *memory_interface,u32 address,u32 value)

{
  ...
  if ((memory_interface->page_table[address >> 0xb] & 0x40000000) == 0) {
    *(u32 *)(address + memory_interface->page_table[address >> 0xb] * 4) = value;
  }
    ...
    if (uVar1 == '\x01') {
      puVar2 = (u32 *)(*pmVar5[uVar3].store_handler.get_pointer)(memory_interface->memory,address);
      ...
      *(u32 *)(puVar4 + (address & uVar3)) = value;
    }
    else if (uVar1 == '\x02') {
                    /* WARNING: Could not recover jumptable at 0x080141e8. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      (*pmVar5[uVar3].store_handler.extended_function.store32)
