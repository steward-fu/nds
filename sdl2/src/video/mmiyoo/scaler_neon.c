...
//		sp  :	src pitch (stride)	bytes	if 0, (src width *
//[2|4]) is used 		dp  :	dst pitch (stride)	bytes	if 0, (src width * [2|4]
//* multiplier) is used
//
//	** NOTE **
...
void scale4x1_c32(void* __restrict src, void* __restrict dst, uint32_t sw,
                  uint32_t sh, uint32_t sp, uint32_t dp) {
    scale4x_c32(src, dst, sw, sh, sp, dp, 1);
}
void scale4x2_c32(void* __restrict src, void* __restrict dst, uint32_t sw,
                  uint32_t sh, uint32_t sp, uint32_t dp) {
    scale4x_c32(src, dst, sw, sh, sp, dp, 2);
}
void scale4x3_c32(void* __restrict src, void* __restrict dst, uint32_t sw,
                  uint32_t sh, uint32_t sp, uint32_t dp) {
    scale4x_c32(src, dst, sw, sh, sp, dp, 3);
}
void scale4x4_c32(void* __restrict src, void* __restrict dst, uint32_t sw,
                  uint32_t sh, uint32_t sp, uint32_t dp) {
...
static void memcpy_neon(void* dst, void* src, uint32_t size) {
    asm volatile(
        ...
        : [s] "+r"(src), [d] "+r"(dst)
        : [sz] "r"(size)
        : "r3", "r4", "q8", "q9", "q10", "q11", "q12", "q13", "q14", "q15",
          "memory", "cc");
}
...
void scale1x1_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x1_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    if ((swl == sp) && (sp == dp)) {
...
{
    uint8_t* finofs = NULL;
    uint32_t swl = 0, swl128 = 0, sadd = 0, dadd = 0;
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x2_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl128 = swl & ~127;
    sadd = sp - swl;
    dadd = dp * 2 - swl;
    finofs = (uint8_t*)src + (sp * sh);
    asm volatile(
        ...
        : "r8", "r9", "lr", "q8", "q9", "q10", "q11", "q12", "q13", "q14",
          "q15", "memory", "cc");
}
...
void scale1x3_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x3_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl128 = swl & ~127;
    sadd = sp - swl;
    ...
    asm volatile(
        ...
        : "+r"(src), "+r"(dst)
        : "r"(swl128), "r"(swl), "r"(sadd), "r"(dadd), "r"(finofs), "r"(dp)
        : "r8", "r9", "r10", "lr", "q8", "q9", "q10", "q11", "q12", "q13",
          "q14", "q15", "memory", "cc");
}
...
void scale1x4_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x4_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl128 = swl & ~127;
    sadd = sp - swl;
    ...
    asm volatile(
        ...
        : "+r"(src), "+r"(dst)
        : "r"(swl128), "r"(swl), "r"(sadd), "r"(dadd), "r"(finofs), "r"(dp)
        : "r8", "r9", "r10", "r11", "lr", "q8", "q9", "q10", "q11", "q12",
...
void scale1x1_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x1_c32(src, dst, sw, sh, sp, dp);
        return;
    }
...
void scale1x2_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x2_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl128 = swl & ~127;
    sadd = sp - swl;
...
void scale1x3_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x3_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl128 = swl & ~127;
    sadd = sp - swl;
...
void scale1x4_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale1x4_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl128 = swl & ~127;
    sadd = sp - swl;
...
{
    uint8_t* finofs = NULL;
    uint32_t swl = 0, swl64 = 0, sadd = 0, dadd = 0;
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x1_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
    ...
    asm volatile(
        ...
        : "r8", "lr", "q0", "q8", "q9", "q10", "q11", "q12", "q13", "q14",
          "q15", "memory", "cc");
}
...
void scale2x2_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x2_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
    ...
    asm volatile(
        ...
        : "+r"(src), "+r"(dst)
        : "r"(swl64), "r"(swl), "r"(sadd), "r"(dadd), "r"(finofs), "r"(dp)
        : "r8", "r9", "lr", "q0", "q8", "q9", "q10", "q11", "q12", "q13", "q14",
          "q15", "memory", "cc");
}
...
void scale2x3_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x3_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
    ...
    asm volatile(
        ...
        : "+r"(src), "+r"(dst)
        : "r"(swl64), "r"(swl), "r"(sadd), "r"(dadd), "r"(finofs), "r"(dp)
        : "r8", "r9", "r10", "lr", "q0", "q8", "q9", "q10", "q11", "q12", "q13",
          "q14", "q15", "memory", "cc");
}
...
void scale2x4_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    asm volatile(
        ...
        : "+r"(src), "+r"(dst)
        : "r"(swl64), "r"(swl), "r"(sadd), "r"(dadd), "r"(finofs), "r"(dp)
        : "r8", "r9", "r10", "r11", "lr", "q0", "q8", "q9", "q10", "q11", "q12",
          "q13", "q14", "q15", "memory", "cc");
}
...
void scale2x1_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x1_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
    ...
    asm volatile(
        ...
        : "+r"(src), "+r"(dst)
        : "r"(swl64), "r"(swl), "r"(sadd), "r"(dadd), "r"(finofs), "r"(dp)
        : "r8", "lr", "q8", "q9", "q10", "q11", "q12", "q13", "q14", "q15",
          "memory", "cc");
}
...
void scale2x2_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x2_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
...
void scale2x3_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x3_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
...
void scale2x4_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale2x4_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl64 = swl & ~63;
    sadd = sp - swl;
...
{
    uint8_t* finofs = NULL;
    uint32_t swl = 0, swl32 = 0, sadd = 0, dadd = 0;
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x1_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x2_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x2_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x3_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x3_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x4_n16(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x4_c16(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x1_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x1_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x2_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x2_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x3_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x3_c32(src, dst, sw, sh, sp, dp);
        return;
    }
    swl32 = swl & ~31;
    sadd = sp - swl;
...
void scale4x4_n32(void* __restrict src, void* __restrict dst, uint32_t sw, uint32_t sh, uint32_t sp, uint32_t dp)
{
    ...
    if (((uintptr_t)src & 3) || ((uintptr_t)dst & 3) || (sp & 3) || (dp & 3)) {
        scale4x4_c32(src, dst, sw, sh, sp, dp);
        return;
    }
