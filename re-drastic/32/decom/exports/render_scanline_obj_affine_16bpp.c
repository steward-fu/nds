 ...
 *
 * Function : render_scanline_obj_affine_16bpp
 * Address  : 080bbc90
 * Program  : drastic
 */
...
u32 render_scanline_obj_affine_16bpp
...

{
  ...
  uVar9 = (uint)lVar2;
  uVar12 = VectorShiftRight(CONCAT44(uVar4,uVar4),0x20);
  iStack_2c = (int)((ulonglong)uVar12 >> 0x20);
  ...
  if ((int)uVar7 < 0) {
    ...
    render_scanline_obj_pixel_offsets_16bpp
              (obj_pixels,
               ...
               obj->row_pitch,uVar7);
    render_scanline_obj_affine_span_16bpp(obj_pixels,puVar11,uVar7);
