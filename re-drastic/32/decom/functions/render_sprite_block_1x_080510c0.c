 ...
 *
 * Function : render_sprite_block_1x
 * Address  : 080510c0
 * Program  : drastic
 */
...
/* DWARF original prototype: void render_sprite_block_1x(video_3d_render_target_struct *
...

{
  ...
  if (((uint)polygon_1 & 1) == 0) {
    render_sprite_load_depth_1x(x,puVar25,height,depth_value);
  }
  else {
    render_sprite_load_depth_colors_id_1x
  ...
  if (occlusion_pass == 0) goto LAB_080517a0;
    ...
    if (uVar12 != 0) {
      ...
      if ((uVar12 < 5) || (puVar29 = texels, uVar23 = uVar22, local_58 = uVar22, uVar22 != 0)) {
        ...
        *texels = uVar32 & 0xff000000 | (uVar32 & 0xff) * uVar15 + uVar15 + (uVar32 & 0xff) >> 6 |
        ...
        uVar22 = uVar23;
        if (uVar12 == uVar23) goto LAB_08051748;
      }
      ...
      if (2 < (uVar12 - 1) - uVar22) {
        ...
        if (uVar12 - uVar22 == uVar23 * 4) goto LAB_08051748;
      }
      uVar23 = *puVar29;
...
LAB_08051748:
  ...
  if (((uint)polygon_1 & 1) == 0) {
    ...
    render_sprite_writeback_1x(puVar27,puVar25,height,depth_value,texels,uVar15,iVar17);
    goto LAB_080517a0;
  }
    ...
    if (uVar12 != 0) {
      ...
      if ((uVar12 < 5) || (puVar11 = texels, uVar32 = uVar23, uVar23 != 0)) {
        ...
        *texels = *texels & 0xffffff | (uVar23 * uVar22 + uVar22 + uVar23 >> 5) << 0x18;
        ...
        if (uVar12 == uVar32) goto LAB_080519ec;
      }
      ...
      if (2 < (uVar12 - 1) - uVar32) {
        ...
        if (uVar26 * 4 - (uVar12 - uVar32) == 0) goto LAB_080519ec;
      }
    ...
    if (uVar12 != 0) {
      ...
      if ((uVar12 < 5) || (puVar11 = texels, uVar23 = uVar22, uVar22 != 0)) {
        ...
        *texels = *texels & uVar26;
        ...
        if (uVar12 == uVar23) goto LAB_080519ec;
      }
      ...
      if (2 < (uVar12 - 1) - uVar23) {
        ...
        if (uVar32 * 4 - (uVar12 - uVar23) == 0) goto LAB_080519ec;
      }
