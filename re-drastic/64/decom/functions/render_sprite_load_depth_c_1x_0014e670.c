 ...
 *
 * Function : render_sprite_load_depth_c_1x
 * Address  : 0014e670
 * Program  : drastic64
 */


void render_sprite_load_depth_c_1x(long param_1,long param_2,uint param_3,int param_4)

{
  ...
  if ((param_4 != 0) && (param_3 != 0)) {
    ...
    uVar5 = param_3 - 1;
    lVar3 = param_2 + ((ulong)(param_4 - 1) + 1) * 0x400;
