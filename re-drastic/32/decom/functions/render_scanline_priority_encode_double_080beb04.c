 ...
 *
 * Function : render_scanline_priority_encode_double
 * Address  : 080beb04
 * Program  : drastic
 */


void render_scanline_priority_encode_double(int param_1,int param_2,int param_3,int param_4)
  ...
  for (uVar5 = (uint)*(byte *)(param_1 + 0x93); pbVar7 = pbVar6, uVar5 != 0; uVar5 = uVar5 - 1) {
    while( true ) {
      ...
      *puVar4 = auVar16._0_8_;
      ...
      uVar5 = uVar5 - 1;
      pbVar7 = pbVar6;
      if (uVar5 == 0) goto priority_encode_double_complete;
    }
    pauVar1 = (undefined (*) [16])(param_2 + uVar3 * 0x20);
