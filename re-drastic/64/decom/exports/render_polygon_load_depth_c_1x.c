 ...
 *
 * Function : render_polygon_load_depth_c_1x
 * Address  : 0014e4e0
 * Program  : drastic64
 */


void render_polygon_load_depth_c_1x(ulong param_1,long param_2,long param_3,int param_4)

{
  ...
  if (param_4 != 0) {
    lVar2 = param_2 + ((ulong)(param_4 - 1) + 1) * 0x400;
