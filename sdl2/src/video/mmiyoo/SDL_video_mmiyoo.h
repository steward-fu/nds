...
#define NDS_DIS_MODE_VH_T2  2
#define NDS_DIS_MODE_S0     3
#define NDS_DIS_MODE_S1     4
#define NDS_DIS_MODE_V0     5
#define NDS_DIS_MODE_V1     6
#define NDS_DIS_MODE_H0     7
#define NDS_DIS_MODE_H1     8
#define NDS_DIS_MODE_VH_S0  9
#define NDS_DIS_MODE_VH_S1  10
...
#define JSON_NDS_AUDIO_FEED "feed"
#define JSON_NDS_AUDIO_DELAY "delay"
