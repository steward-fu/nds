 ...
 *
 * Function : render_polygon_generate_texture_addresses_clamp_wrap_c
 * Address  : 001470a0
 * Program  : drastic64
 */
...
void render_polygon_generate_texture_addresses_clamp_wrap_c
               (undefined8 *param_1,short *param_2,ulong param_3,uint param_4,int param_5)
