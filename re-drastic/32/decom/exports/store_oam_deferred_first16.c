 ...
 *
 * Function : store_oam_deferred_first16
 * Address  : 0800b8c8
 * Program  : drastic
 */
...
void store_oam_deferred_first16(memory_struct *memory,u32 address,u16 value)

{
  ...
  if ((uint)*(ushort *)((int)puVar1 + uVar2) != (uint)value) {
    ...
    video_2d_queue_event
              (video_2d,uVar2 + 0x200000,(uint)value,2,(uint)memory->system->scanline_number);
