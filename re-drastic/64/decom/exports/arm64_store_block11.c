 ...
 *
 * Function : arm64_store_block11
 * Address  : 0018ed64
 * Program  : drastic64
 */


void arm64_store_block11(ulong param_1)

{
  ...
  if ((uVar5 >> 0x3e & 1) == 0) {
    ...
    *puVar1 = *(undefined8 *)(in_x9 + -0x120);
    ...
    puVar1[2] = uVar7;
    puVar1[3] = uVar8;
    uVar4 = *(undefined4 *)(in_x9 + -0xfc);
    *(undefined4 *)(puVar1 + 4) = *(undefined4 *)(in_x9 + -0x100);
    *(undefined4 *)((long)puVar1 + 0x24) = uVar4;
    *(undefined4 *)(puVar1 + 5) = *(undefined4 *)(in_x9 + -0xf8);
    return;
  }
  if (-1 < (long)uVar5) {
  ...
  *(uint *)(unaff_x28 + 0x2334) = uVar2;
  iVar3 = cpu_block_check_allocation_block11();
  if (iVar3 == 0) {
  ...
  *(undefined4 *)(unaff_x28 + 0x23bc) = uVar4;
  ...
  nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018ee84. Too many branches */
