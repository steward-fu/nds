 ...
 *
 * Function : FUN_08091264
 * Address  : 08091264
 * Program  : drastic16
 */


void FUN_08091264(undefined8 *param_1,int param_2,int param_3)

{
  ...
  uVar3 = (uint)*(ushort *)(param_2 + 0x3f0);
  uVar5 = *(undefined4 *)(&DAT_0aaec910 + uVar3 * 4);
  puVar2 = (ushort *)(param_2 + 0x3f4);
  while( true ) {
    auVar8._4_4_ = uVar5;
    auVar8._0_4_ = uVar5;
    auVar8._8_8_ = 0;
