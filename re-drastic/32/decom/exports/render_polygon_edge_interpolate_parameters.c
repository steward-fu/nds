 ...
 *
 * Function : render_polygon_edge_interpolate_parameters
 * Address  : 080c2de8
 * Program  : drastic
 */
...
void render_polygon_edge_interpolate_parameters
               (int *param_1,int param_2,undefined8 *param_3,byte *param_4,int param_5)

{
  ...
  auVar8 = _color_round_value;
  puVar14 = (undefined2 *)(param_2 + 0x2c0);
  puVar10 = (undefined2 *)(param_2 + 0x420);
  puVar9 = (undefined2 *)(param_2 + 0x580);
