...
void extended_store8(long param_1,ulong param_2,undefined param_3)

{
  ...
  if (*(byte *)(lVar2 + 0x59) == 1) {
    ...
    if (*(char *)(lVar2 + 0x58) == *(char *)(lVar2 + 0x59)) {
      ...
      *(long *)(param_1 + (ulong)(uVar6 >> 0xb) * 8) =
           (long)(puVar5 + (-(param_2 & 0xfffff800) - (param_2 & 0x7ff))) >> 2;
      *puVar5 = param_3;
    }
    else {
      *puVar5 = param_3;
  ...
  if (uVar9 == 2) {
                    /* WARNING: Could not recover jumptable at 0x00118b0c. Too many branches */
