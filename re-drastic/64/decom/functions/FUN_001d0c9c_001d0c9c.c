 ...
 *
 * Function : FUN_001d0c9c
 * Address  : 001d0c9c
 * Program  : drastic64
 */


undefined FUN_001d0c9c(ComprDataIO **param_1)
  ...
  if (uVar15 == 6) {
    ...
    *(int *)(param_1 + 1) = iVar11 + 1;
    ...
    if (uVar15 == 8) {
      ...
      CVar4 = pCVar13[(long)iVar11 + 2];
      CVar5 = pCVar13[(long)iVar11 + 1];
      *(int *)(param_1 + 1) = iVar11 + 2;
      *(uint *)((long)param_1 + 0xc) = uVar2;
      uVar15 = ((uint)(byte)CVar4 | (uint)(byte)CVar6 << 0x10 | (uint)(byte)CVar5 << 8) >>
               (ulong)(8 - uVar2 & 0x1f) & 0xffff;
      if (uVar15 == 0) {
        uVar10 = Unpack::AddVMCode((Unpack *)param_1,uVar7,(uchar *)0x0,0);
        return uVar10;
      }
    }
  }
...
LAB_001d0e70:
        ...
        if (iVar11 < 0x4001) {
          ...
          *(int *)(param_1 + 0x1a) = iVar16;
        }
        iVar11 = ComprDataIO::UnpRead(*param_1,(uchar *)(pCVar13 + sVar12),(long)(0x8000 - iVar16));
        if (0 < iVar11) {
          iVar11 = iVar11 + *(int *)(param_1 + 0x1a);
          *(int *)(param_1 + 0x1a) = iVar11;
          *(int *)((long)param_1 + 0xd4) = iVar11 + -0x1e;
          iVar11 = *(int *)(param_1 + 1);
          goto LAB_001d0d58;
        }
        *(int *)((long)param_1 + 0xd4) = *(int *)(param_1 + 0x1a) + -0x1e;
...
LAB_001d0d58:
    ...
    __ptr[lVar14] =
         (uchar)((((uint)(byte)pCVar13[lVar8 + 2] | (uint)(byte)pCVar13[lVar1] << 0x10 |
                 ...
                 (ulong)(8U - *(int *)((long)param_1 + 0xc) & 0x1f)) >> 8);
    *(int *)(param_1 + 1) = iVar11;
    *(uint *)((long)param_1 + 0xc) = uVar2 & 7;
    lVar14 = lVar14 + 1;
  } while ((int)lVar14 < (int)uVar15);
  uVar10 = Unpack::AddVMCode((Unpack *)param_1,uVar7,__ptr,uVar15);
LAB_001d0ec8:
  if (__ptr == (uchar *)0x0) {
    return uVar10;
  }
