 ...
 *
 * Function : video_3d_bin_polygons_4x
 * Address  : 08076010
 * Program  : drastic
 */
...

{
      ...
      do {
        ...
        if (uVar13 - 2 < 7) {
          ...
          if (uVar12 != uVar8) {
            ...
            uVar13 = 0xfff << ((int)uVar12 >> 5 & 0xffU) & 0xfffU >> (0xbU - (iVar9 >> 5) & 0xff);
            if ((uVar13 & 1) != 0) {
              uVar10 = *puVar5;
  ...
  video_3d_bin_polygons_y_sort_4x(geometry,polygon_bins,polygon_list,base_vertexes);
  return;
}
