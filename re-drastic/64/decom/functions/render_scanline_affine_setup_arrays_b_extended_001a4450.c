 ...
 *
 * Function : render_scanline_affine_setup_arrays_b_extended
 * Address  : 001a4450
 * Program  : drastic64
 */
...
undefined8
render_scanline_affine_setup_arrays_b_extended
...

{
  ...
  do {
    ...
    auVar8._0_8_ = CONCAT26((auVar7._12_2_ + (ushort)((byte)(uVar19 >> 0xb) & bVar20)) * 2,
                            CONCAT24((auVar7._8_2_ + (ushort)((byte)(uVar13 >> 0xb) & bVar20)) * 2,
                                     CONCAT22((auVar7._4_2_ +
                                              (ushort)((byte)(uVar18 >> 0xb) & bVar20)) * 2,
                                              (auVar7._0_2_ +
                                              (ushort)((byte)(uVar17 >> 0xb) & bVar20)) * 2)));
    auVar8._8_2_ = (auVar11._0_2_ + (ushort)((byte)(iVar9 + uVar17 >> 0xb) & bVar20)) * 2;
    auVar8._10_2_ = (auVar11._4_2_ + (ushort)((byte)(iVar9 + uVar18 >> 0xb) & bVar20)) * 2;
    auVar8._12_2_ = (auVar11._8_2_ + (ushort)((byte)(iVar9 + uVar13 >> 0xb) & bVar20)) * 2;
    auVar8._14_2_ = (auVar11._12_2_ + (ushort)((byte)(iVar9 + uVar19 >> 0xb) & bVar20)) * 2;
    puVar4 = puVar3 + 2;
  ...
  render_scanline_affine_load_tile_map_entries_extended_asm(param_3,param_4,0xff);
  render_scanline_affine_setup_flip_masks_asm(param_6,param_3,0xff);
  return 0x100;
}
