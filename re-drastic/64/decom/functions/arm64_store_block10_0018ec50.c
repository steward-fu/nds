 ...
 *
 * Function : arm64_store_block10
 * Address  : 0018ec50
 * Program  : drastic64
 */


void arm64_store_block10(ulong param_1)

{
  ...
  *(uint *)(unaff_x28 + 0x2334) = uVar2;
  iVar3 = cpu_block_check_allocation_block10();
  if (iVar3 == 0) {
  ...
  *(undefined4 *)(unaff_x28 + 0x23bc) = uVar4;
  ...
  nzcv = (ulong)*(uint *)(unaff_x28 + 0x2354);
                    /* WARNING: Could not recover jumptable at 0x0018ed60. Too many branches */
