 ...
 *
 * Function : render_scanline_color_effects_apply_offset
 * Address  : 080bfc24
 * Program  : drastic
 */
...
undefined8
render_scanline_color_effects_apply_offset
          (undefined8 *param_1,undefined (*param_2) [16],undefined8 *param_3,undefined8 *param_4,
          undefined8 *param_5)

{
  ...
  do {
    ...
    VectorMultiplyAccumulate(auVar20._0_8_,uVar16,1,1);
    uVar24 = auVar1._0_8_;
    auVar22 = VectorMultiplyAccumulate(uVar25,uVar24,1,1);
    VectorMultiply(auVar18._8_8_,uVar15,1,1);
    VectorMultiplyAccumulate(auVar20._8_8_,uVar17,1,1);
    auVar23 = VectorMultiplyAccumulate(uVar26,uVar24,1,1);
    VectorMultiply(auVar19._0_8_,uVar14,1,1);
    VectorMultiplyAccumulate(auVar21._0_8_,uVar16,1,1);
    auVar18 = VectorMultiplyAccumulate(uVar25,uVar24,1,1);
    VectorMultiply(auVar19._8_8_,uVar15,1,1);
    VectorMultiplyAccumulate(auVar21._8_8_,uVar17,1,1);
    auVar20 = VectorMultiplyAccumulate(uVar26,uVar24,1,1);
    VectorMultiply(*(undefined8 *)puVar2,uVar14,1,1);
    VectorMultiplyAccumulate(*(undefined8 *)puVar4,uVar16,1,1);
    auVar19 = VectorMultiplyAccumulate(uVar25,uVar24,1,1);
    VectorMultiply(*(undefined8 *)(puVar3 + 8),uVar15,1,1);
    VectorMultiplyAccumulate(*(undefined8 *)(puVar5 + 8),uVar17,1,1);
    auVar21 = VectorMultiplyAccumulate(uVar26,uVar24,1,1);
