...
void store_memory8(memory_interface_struct *memory_interface,u32 address,u8 value)

{
  ...
  if ((memory_interface->page_table[address >> 0xb] & 0x40000000) == 0) {
    *(u8 *)(address + memory_interface->page_table[address >> 0xb] * 4) = value;
  }
    ...
    if (uVar1 == '\x01') {
      ...
      *puVar3 = value;
      ...
      puVar3[address & uVar2] = value;
                    ...
                    /* WARNING: Could not recover jumptable at 0x08013e58. Too many branches */
