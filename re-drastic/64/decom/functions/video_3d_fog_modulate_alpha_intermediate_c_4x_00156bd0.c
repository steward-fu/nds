 ...
 *
 * Function : video_3d_fog_modulate_alpha_intermediate_c_4x
 * Address  : 00156bd0
 * Program  : drastic64
 */


void video_3d_fog_modulate_alpha_intermediate_c_4x
...

{
  ...
  if ((param_3 < param_1 + 0x80 && param_1 < param_3 + 0x20 || uVar9 < 0x7e) ||
      (param_3 >= param_1 + 0x80 || param_1 >= param_3 + 0x20) && uVar9 == 0x7e) {
    lVar10 = 0;
    do {
      while( true ) {
