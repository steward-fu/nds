 ...
 *
 * Function : arm_load_ext16_signed
 * Address  : 080ab58c
 * Program  : drastic
 */


undefined8 arm_load_ext16_signed(uint param_1,undefined4 param_2,u32 param_3,u32 param_4)

{
  ...
  return CONCAT44(unaff_r11[-1].page_allocation_bitmap_fine[0xfc0],
                  (int)*(short *)(unaff_r11[-1].page_allocation_bitmap_fine[0xfc0] +
                                 (param_1 & 0x7ffe)));
}
