 ...
 *
 * Function : FUN_08010560
 * Address  : 08010560
 * Program  : drastic16
 */


void FUN_08010560(int param_1,uint param_2,undefined2 param_3)

{
  ...
  if ((uVar3 & 0x40000000) == 0) {
    *(undefined2 *)(uVar3 * 4 + param_2) = param_3;
  }
    ...
    if (cVar1 == '\x01') {
      puVar2 = (undefined2 *)(**(code **)(iVar5 + 0x10))(*(undefined4 *)(param_1 + 0x800004));
      if (*(char *)(iVar5 + 0x2c) == *(char *)(iVar5 + 0x2d)) {
        ...
        *(uint *)(param_1 + (uVar3 >> 0xb) * 4) = (int)puVar2 + (-uVar3 - (param_2 & 0x7ff)) >> 2;
      }
      *puVar2 = param_3;
    }
    else if (cVar1 == '\0') {
      ...
      *(undefined2 *)(iVar4 + (uVar3 & param_2)) = param_3;
    }
    else if (cVar1 == '\x02') {
      (**(code **)(iVar5 + 0x14))
