...
void store_palette_deferred_first32(memory_struct *memory,u32 address,u32 value)

{
  ...
  if (value != *(u32 *)((int)puVar1 + uVar2)) {
    ...
    video_2d_queue_event(video_2d,uVar2 + 0x100000,value,4,(uint)memory->system->scanline_number);
