...
void block_itcm_branch_arm(uint param_1)

{
  ...
  uVar1 = *(uint *)(*(long *)(unaff_x28 + 0x2270) + (ulong)(param_1 >> 2 & 0x1fff) * 4);
  if (uVar1 != 0) {
                    /* WARNING: Could not recover jumptable at 0x0018cb20. Too many branches */
