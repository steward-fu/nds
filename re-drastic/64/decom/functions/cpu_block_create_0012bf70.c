...
long cpu_block_create(long param_1,uint param_2,uint param_3)

{
  ...
  local_38 = lVar38 + 0x1420030;
  local_f = 0;
  local_20 = param_2;
  if ((((*(int *)(param_1 + 0x210c) != 1) || (local_f = 8, param_2 < 0xffff0000)) &&
      (0x1ffffff < param_2)) &&
...
LAB_0012ce9c:
  ...
  local_78 = 0;
  local_28 = *(long **)(nds_system + *(long *)(param_1 + 0x2088) + 0xffe140);
  local_14 = 0;
  local_e = '\0';
  if ((*(int *)(param_1 + 0x210c) == 1) && (local_78 = 2, uVar37 < 0x2000000)) {
    local_74 = 0;
  }
  else {
    local_74 = (uVar37 >> 0x18 != 2) + 1;
  }
  uVar11 = 0xf;
  lVar41 = 0;
  bVar9 = false;
...
LAB_0012c0c8:
  ...
  uVar14 = convert_thumb_instruction_to_arm(sVar10,&local_3c);
  uVar30 = uVar37 + 4;
  uVar37 = uVar37 + 2;
  *(int *)((long)puVar24 + local_68) = (int)uVar14;
...
LAB_0012ccfc:
              ...
              if (local_78 == 0 || uVar17 != 0xe) goto LAB_0012ccfc;
              uVar16 = (ulong)uVar33;
              uVar26 = 0;
              uVar17 = 0;
              uVar25 = 0;
              ...
              if (local_78 == 0) goto LAB_0012ccfc;
              uVar16 = (ulong)uVar33;
          ...
          if (local_78 == 0) goto LAB_0012cab4;
...
LAB_0012cfbc:
    ...
    if ((uVar33 >> 0xf & 1) != 0) {
      ...
      if (uVar15 == 0) {
        ...
        *(uint *)(local_28 + (ulong)local_14 * 5 + 3) = uVar15;
        *(uint *)((long)local_28 + (ulong)local_14 * 0x28 + 0x1c) = uVar37;
        *(undefined4 *)(local_28 + (ulong)local_14 * 5 + 4) = 0;
        *(short *)((long)local_28 + (ulong)local_14 * 0x28 + 0x24) = (short)lVar41;
        uVar33 = uVar33 >> 0x1c;
        *(undefined2 *)((long)local_28 + (ulong)local_14 * 0x28 + 0x26) = 0;
        if (uVar15 < uVar37 && uVar33 < 0xd || uVar15 < uVar37 && uVar33 == 0xd) {
          uVar11 = uVar33;
        }
        if ((iVar18 != local_74) && (local_74 == 2 || iVar18 == 2)) {
          *(undefined4 *)(local_28 + (ulong)local_14 * 5 + 4) = 4;
        }
        if ((iVar18 == 0) &&
           ((local_74 != 0 ||
            ((8 < (byte)nds_system[*(long *)(param_1 + 0x2088) + (uVar16 >> 2 & 0x1fff) + 0xfdc038]
             && ((uVar16 & 1) == 0)))))) {
          *(undefined4 *)(local_28 + (ulong)local_14 * 5 + 4) = 2;
        }
      }
      local_14 = uVar32;
      if (0xd < uVar33) {
    ...
    if ((uint)uVar40 == uVar30) {
      ...
      local_30 = (uint *)realloc(local_30,uVar40 << 5);
    }
    if (lVar41 == 0x7ff) {
      lVar20 = *(long *)(param_1 + 0x2088);
LAB_0012c558:
    ...
    lVar41 = lVar41 + 1;
    local_44 = (uint)lVar41;
    local_68 = lVar41 * 0x20;
    puVar13 = local_30 + lVar41 * 8;
...
LAB_0012c620:
  local_44 = local_44 - 2;
  bVar9 = local_44 != 0;
  uVar37 = local_44 & 0xffff;
  local_e = '\x02';
  lVar20 = *(long *)(param_1 + 0x2088);
LAB_0012cff0:
  if (bVar9) {
LAB_0012d7d0:
    local_68 = (ulong)(local_44 - 1) << 5;
LAB_0012c568:
    *(undefined2 *)((long)local_30 + local_68 + 0x16) = 0x7fff;
    *(undefined *)((long)local_30 + local_68 + 0x19) = 0xf;
  }
  uVar27 = (uint)local_14;
  local_16 = (ushort)((uVar37 & 0x7fff) << 1);
  local_18 = (ushort)uVar37;
  uVar40 = *(long *)(nds_system + lVar20 + 0xffe140) + (ulong)local_14 * 0x28;
  if (param_3 != 0) {
    local_16 = local_18;
  }
  *(ulong *)(nds_system + lVar20 + 0xffe140) = uVar40;
  if (uVar40 < lVar20 + 0x1420000U) {
    if (local_14 == 0) goto LAB_0012d468;
  }
  else {
  ...
  do {
    ...
    plVar22 = plVar22 + 5;
  } while (local_28 + (ulong)(uVar27 - 1) * 5 + 5 != plVar22);
  if ((int)uVar40 == -1) {
LAB_0012d468:
    uVar40 = (ulong)local_18;
  }
  else {
    uVar11 = 0;
    local_16 = (ushort)(uVar40 >> 1);
    uVar30 = (uint)(uVar40 >> 1);
    if (param_3 == 0) {
      uVar30 = (uint)(uVar40 >> 2);
    }
    uVar40 = (ulong)(uVar30 & 0xffff);
    local_18 = (ushort)uVar30;
    local_e = '\x03';
    plVar22 = local_28;
    do {
    ...
    *(ushort *)((long)plVar22 + 0x24) = local_18 - 1;
  }
  local_30 = (uint *)realloc(local_30,uVar40 << 5);
  if ((local_14 != 0) && ((*(uint *)(local_28 + 3) & 0xfffffffe) == local_20)) {
    uVar32 = 0;
    puVar13 = local_30 + 5;
    do {
      puVar24 = puVar13 + 8;
      ...
      puVar13 = puVar24;
    } while (local_30 + (ulong)*(ushort *)((long)local_28 + 0x24) * 8 + 0xd != puVar24);
    ...
    do {
      while( true ) {
        ...
        if (puVar13 == local_30 + (ulong)*(ushort *)((long)local_28 + 0x24) * 8 + 8)
        goto LAB_0012d1f0;
      }
      puVar13 = puVar13 + 8;
    } while (puVar13 != local_30 + (ulong)*(ushort *)((long)local_28 + 0x24) * 8 + 8);
LAB_0012d1f0:
    local_f = local_f | 4;
  }
LAB_0012d200:
  cpu_block_fill_allocation(param_1,param_2,(ulong)local_16 << 1);
  uVar27 = (uint)local_14;
  uVar37 = *(uint *)(nds_system + lVar38 + 0xfc4034);
  uVar11 = (uint)local_16;
  ...
  if (local_14 != 0) {
    ...
    do {
      ...
      if ((*(uint *)(plVar22 + 4) & 6) == 0) {
        ...
        uVar15 = uVar30 - local_20;
        if ((((int)uVar15 < 1 || uVar11 * 2 < uVar15) || 0 < (int)uVar15 && uVar11 * 2 == uVar15) ||
           (uVar30 < *(uint *)((long)plVar22 + 0x1c))) {
          if (*(int *)(local_38 + 0xa0004) != 0) {
            puVar24 = (uint *)(local_38 + 0x80004);
            do {
              if (uVar30 == *puVar24) {
                uVar27 = *(uint *)(local_38 + 0x80000);
                lVar20 = local_38 + (ulong)uVar27 * 0x10;
                *(uint *)(lVar20 + 8) = uVar30;
                *(uint *)(local_38 + 0x80000) = uVar27 + 1;
                *plVar22 = 0;
                plVar22[2] = lVar20;
              ...
              puVar24 = puVar24 + 1;
                     ...
                     (uint *)(local_38 + 0x80008 + (ulong)(*(int *)(local_38 + 0xa0004) - 1) * 4));
          }
...
LAB_0012d2ec:
  ...
  puVar24 = puVar13 + (ulong)local_18 * 8 + -8;
  local_12 = *(ushort *)((long)puVar24 + 0x12);
  *(uint *)(nds_system + lVar38 + 0xfc4034) = uVar37;
  local_10 = *(byte *)(puVar24 + 6) & 0xf;
  if (local_18 != 0) {
    puVar4 = puVar24 + ~(ulong)(local_18 - 1) * 8;
    do {
      while( true ) {
        ...
        *(ushort *)((long)puVar24 + 0x16) = uVar25 | local_12;
        *(byte *)((long)puVar24 + 0x19) = bVar23 | local_10;
        if (*puVar24 >> 0x1c < 0xe) break;
        puVar1 = puVar24 + 6;
        puVar2 = puVar24 + 5;
        puVar3 = (ushort *)((long)puVar24 + 0x12);
        puVar24 = puVar24 + -8;
        local_10 = *(byte *)puVar1 & 0xf | (bVar23 | local_10) & (*(byte *)puVar1 >> 4 ^ 0xff);
        local_12 = *puVar3 | (uVar25 | local_12) & (*(ushort *)puVar2 ^ 0xffff);
        if (puVar4 == puVar24) goto LAB_0012ce74;
      }
      puVar1 = puVar24 + 6;
      puVar3 = (ushort *)((long)puVar24 + 0x12);
      puVar24 = puVar24 + -8;
      local_10 = *(byte *)puVar1 & 0xf | bVar23 | local_10;
      local_12 = *puVar3 | uVar25 | local_12;
    } while (puVar24 != puVar4);
  }
LAB_0012ce74:
  lVar41 = cpu_translate_block(&local_38,param_1,param_2,param_3);
  goto LAB_0012ce9c;
}
