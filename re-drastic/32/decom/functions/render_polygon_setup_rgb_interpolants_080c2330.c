 ...
 *
 * Function : render_polygon_setup_rgb_interpolants
 * Address  : 080c2330
 * Program  : drastic
 */
...
undefined8
render_polygon_setup_rgb_interpolants(int param_1,undefined8 *param_2,int param_3,int param_4)

{
  ...
  puVar13 = (undefined4 *)(param_1 + 0x580);
