 ...
 *
 * Function : render_polygon_generate_texture_addresses_wrap_clamp
 * Address  : 080c24f0
 * Program  : drastic
 */


void render_polygon_generate_texture_addresses_wrap_clamp
  ...
  do {
    ...
    *param_1 = auVar8._0_8_;
    ...
    param_3 = iVar4 + -8;
                    ...
                    /* WARNING: Could not recover jumptable at 0x080c2558. Too many branches */
