 ...
 *
 * Function : render_scanline_affine_setup_map_indexes_b_extended_c
 * Address  : 001a3110
 * Program  : drastic64
 */


void render_scanline_affine_setup_map_indexes_b_extended_c
...

{
  ...
  do {
    ...
    uVar7 = iVar3 + param_3 >> 0xb;
    uVar10 = iVar3 + uVar24 >> 0xb;
    uVar11 = iVar3 + uVar25 >> 0xb;
    uVar12 = iVar3 + uVar27 >> 0xb;
    ...
    psVar2 = psVar1 + 8;
    psVar1[8] = (auVar9._0_2_ + sVar17) * 2;
    psVar1[9] = (auVar9._4_2_ + (short)((uint)uVar18 >> 0x10)) * 2;
    psVar1[10] = (auVar9._8_2_ + (short)((uint6)uVar19 >> 0x20)) * 2;
    psVar1[0xb] = (auVar9._12_2_ +
                  (short)(CONCAT17((byte)(uVar23 >> 8) & bVar31,
                                   CONCAT16((byte)uVar23 & bVar30,uVar19)) >> 0x30)) * 2;
    *psVar1 = (auVar5._0_2_ + sVar14) * 2;
    psVar1[1] = (auVar5._4_2_ +
                (short)(CONCAT13((byte)((uVar28 >> 0xb) >> 8) & bVar31,
                                 CONCAT12((byte)(uVar28 >> 0xb) & bVar30,sVar14)) >> 0x10)) * 2;
    psVar1[2] = (auVar5._8_2_ + sVar16) * 2;
    psVar1[3] = (auVar5._12_2_ +
                (short)(CONCAT13((byte)((uVar29 >> 0xb) >> 8) & bVar31,
                                 CONCAT12((byte)(uVar29 >> 0xb) & bVar30,sVar16)) >> 0x10)) * 2;
    psVar1 = psVar2;
