...
ulong extended_load8(long param_1,ulong param_2)

{
  ...
  if (*(byte *)(lVar1 + 0x58) == 1) {
    uVar3 = uVar8 & 0x7ff;
    pbVar7 = (byte *)(**(code **)(lVar1 + 8))(*(undefined8 *)(nds_system + param_1 + 0xb04008));
    uVar6 = uVar8 - uVar3;
    ...
    *(ulong *)(param_1 + (ulong)(uVar6 >> 0xb) * 8) =
         (long)(pbVar7 + (-(ulong)(uVar8 - uVar3) - (ulong)uVar3)) >> 2 | 0x4000000000000000;
    return (ulong)*pbVar7;
  }
  if (uVar15 == 2) {
                    /* WARNING: Could not recover jumptable at 0x00118354. Too many branches */
  ...
  *(ulong *)(param_1 + (uVar14 >> 0xb) * 8) = uVar4;
  return (ulong)*(byte *)(lVar13 + uVar12);
}
