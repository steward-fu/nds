 ...
 *
 * Function : lua_set_ds_memory_arm7_32
 * Address  : 080a70a4
 * Program  : drastic
 */
...
int lua_set_ds_memory_arm7_32(lua_State *L)

{
  ...
  uVar2 = ((lua_state.system)->cpu_arm7).reg[(uVar2 >> 0xb) + 0x15];
  if ((uVar2 & 0x40000000) == 0) {
    *(u32 *)(address_00 + uVar2 * 4) = value_00;
    ...
    extended_store32(&((lua_state.system)->cpu_arm7).memory_interface,address_00,value_00);
  }
  return 0;
}
